...
public class APInUtils { 
	private static Logger log = Logger.getLogger(APInUtils.class);
	static String  encrypt_key="njvs90z1";
	static String  md5encrypt_key="sdf7&^#gfas";
	static String  cagent="B20_AGIN";
	...
	public static String isCustomerExist(String loginname){
		...
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/method=ice"+"/\\\\/oddtype=B";
	...
	public static String CheckOrCreateGameAccount(String loginname,String password){
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/method=lg/\\\\/actype="+getActype(loginname)+"/\\\\/password=ki_"+password;
			String targetParams=des.encrypt(params);
			String key=EncryptionUtil.encryptPassword(targetParams+md5encrypt_key);
			String url=dspurl+"/doBusiness.do?params="+targetParams+"&key="+key;
			httpClient=HttpUtils.createHttpClient();
	...
	public static String GetBalance(String loginname,String password){
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/method=gb/\\\\/actype="+getActype(loginname)+"/\\\\/password=ki_"+password;
			String targetParams=des.encrypt(params);
	...
	public static String PrepareTransferCredit(String loginname,String billno,String type,Double credit,String password)throws PostFailedException, ResponseFailedException{
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/actype="+getActype(loginname)+"/\\\\/method=tc/\\\\/billno="+cagent+billno+"/\\\\/type="+type+"/\\\\/credit="+credit+"/\\\\/password=ki_"+password;
			String targetParams=des.encrypt(params);
			String key=EncryptionUtil.encryptPassword(targetParams+md5encrypt_key);
			String url=dspurl+"/doBusiness.do?params="+targetParams+"&key="+key;
			httpClient=HttpUtils.createHttpClient();
	...
	public static String TransferCreditConfirm(String loginname,String billno,String type,Double credit,String password,Integer flag){
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/actype="+getActype(loginname)+"/\\\\/method=tcc/\\\\/billno="+cagent+billno+"/\\\\/flag="+flag+"/\\\\/type="+type+"/\\\\/credit="+credit+"/\\\\/password=ki_"+password;
			String targetParams=des.encrypt(params);
			String key=EncryptionUtil.encryptPassword(targetParams+md5encrypt_key);
			String url=dspurl+"/doBusiness.do?params="+targetParams+"&key="+key;
			httpClient=HttpUtils.createHttpClient();
	...
	public static String SearchTransferResult(String loginname,String billno){
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/method=str/\\\\/billno="+cagent+billno;
			String targetParams=des.encrypt(params);
			String key=EncryptionUtil.encryptPassword(targetParams+md5encrypt_key);
			String url=dspurl+"/doBusiness.do?params="+targetParams+"&key="+key;
			httpClient=HttpUtils.createHttpClient();
	...
	public static String UpdateTransferResultStatus(String loginname,String billno,String operator,Integer flag){
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/method=uts/\\\\/billno="+billno+"/\\\\/flag="+flag+"/\\\\/operator="+operator;
			String targetParams=des.encrypt(params);
			String key=EncryptionUtil.encryptPassword(targetParams+md5encrypt_key);
			String url=dspurl+"/doBusiness.do?params="+targetParams+"&key="+key;
			httpClient=HttpUtils.createHttpClient();
	...
	public static String forwardGame(String loginname,String password,String website,Integer sid){
		...
		PostMethod postMethod = null;
		try {
			String params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/dm="+website+"/\\\\/actype="+getActype(loginname)+"/\\\\/password=ki_"+password+"/\\\\/sid="+sid;
			String targetParams=des.encrypt(params);
			String key=EncryptionUtil.encryptPassword(targetParams+md5encrypt_key);
	...
	public static void main(String[] args) {
		System.out.println(APInUtils.getActype("qytest01"));
...
//		System.out.println(EncryptionUtil.encryptPassword("test"+13+System.currentTimeMillis()+"jsn72ksmm"));
		...
		System.out.println(APInUtils.GetBalance("woody","1223456"));
