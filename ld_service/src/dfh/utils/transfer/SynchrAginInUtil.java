...
public class SynchrAginInUtil {
	
	private static Logger log = Logger.getLogger(SynchrAginInUtil.class);
	
	private static SynchrAginInUtil instance = null;
	
	private SynchrAginInUtil(){
		
	}
	
	public static SynchrAginInUtil getInstance() {
		if (instance == null) {
			return instance = new SynchrAginInUtil();
		} else {
			return instance;
		}
	}
