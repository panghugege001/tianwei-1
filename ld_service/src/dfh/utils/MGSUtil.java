...
public class MGSUtil {
	...
	public static String Login(String account, String password, String itemId, String appId, String token,
			String demoMode,String ip,String session) {
			...
			if (a.has("error")) {
				...
				if (getUserResult == false) {
					...
					if (StringUtil.isEmpty(createPlayerAccount)) {
						...
						return Login(account, password, itemId, appId, token, demoMode,ip,session);
					}
				}
			}
	 ...
	 * @return
	 */
	public static String launchGameUrl(String account, String password, String itemId, String appId,
			String demoMode,String ip,String session) {
		// 获取token
		String token = getAuthToken();
		if (StringUtils.isNotEmpty(token)) {
			// 登录,获取游戏连接
			String result = Login(account, password, itemId, appId, token, demoMode,ip,session);
