...
public class Keno2Util {
	...
	public static String VendorSite = "http://keno2.jiekoue68.com/";
	public static String FundLink = "http://www.lehu66.com/asp/payPage.aspx";
	...
	public static void main(String[] args) {
		String str=Keno2Util.login("vickytest", "admin_admin", "127.0.0.1", "200000000290482", "测试");
