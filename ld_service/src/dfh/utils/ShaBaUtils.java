...
public class ShaBaUtils {
	...
	private static final String URL = "http://tsa.l0030.ig128.com/api/";// 测试环境
	// public static String TRANSITURL =
	// "http://sbtyapitransit.com/shaba/sendPost.php";
	// public static String TRANSITURL =
	// "http://127.0.0.1:6080/shaba/sendPost.php";//测试环境
	...
	private static String sendPost(String method, String parameters) {
		...
		PostMethod med = new PostMethod(URL + method);
	 ...
	 */
	public static String CreateMember(String loginname, String oddstype, Integer currency, String custominfo1,
			String custominfo2, String custominfo3, String custominfo4, String custominfo5) {
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_member_id=" + PREFIX + loginname + "&operatorid="
				+ "&firstname=" + "&lastname=" + "&username=" + PREFIX + loginname + "&oddstype=" + oddstype
				+ "&currency=" + currency + "&maxtransfer=" + MAXTRANSFER + "&mintransfer=" + MINTRANSFER
				+ "&custominfo1=" + OPERATORID + "&custominfo2=" + custominfo2 + "&custominfo3=" + custominfo3
	 ...
	 * @return
	 */
	public static String UpdateMember(String loginname, String firstname, String lastname, BigDecimal maxtransfer,
			BigDecimal mintransfer, String custominfo1, String custominfo2, String custominfo3, String custominfo4,
			String custominfo5) {
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_member_id=" + PREFIX + loginname + "&firstname="
				+ firstname + "&lastname=" + lastname + "&maxtransfer=" + maxtransfer + "&mintransfer=" + mintransfer
	 ...
	 *            玩家账号
	 * @param wallet_id
	 *            1:Sportsbook 5:AG 6:GD
	 * @return
	 */
	@SuppressWarnings("rawtypes")
	public static BigDecimal CheckUserBalance(String loginname) {
		String vendor_member_ids = PREFIX + loginname;
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_member_ids=" + vendor_member_ids + "&wallet_id=" + 1;
	...
	public static String SetMemberBetSetting(String loginname) {
		...
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_member_id=" + PREFIX + loginname + "&bet_setting="
				+ bet_setting;
	...
	public static List GetMemberBetSetting(String loginname) {
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_member_id=" + PREFIX + loginname;
	 ...
	 * @param currency
	 * @param direction
	 *            资金转移方向 0 转出（Withdraw） 1 转入（Deposit）
	 * @param wallet_id
	 *            钱包ID 1:Sportsbook 5:AG 6:GD
	 * @return
	 */
	public static Boolean FundTransfer(String vendor_trans_id, String loginname, Double amount, Integer currency,
			Integer direction, Integer wallet_id) {
		if (vendor_trans_id == null) {
			return Boolean.FALSE;
		}
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_member_id=" + PREFIX + loginname + "&vendor_trans_id="
				+ vendor_trans_id + "&amount=" + amount + "&currency=" + currency + "&direction=" + direction
				+ "&wallet_id=" + wallet_id;
	...
	public static FundTranfer CheckFundTransfer(String vendor_trans_id, Integer wallet_id) {
		String parameters = "vendor_id=" + VENDOR_ID + "&vendor_trans_id=" + vendor_trans_id + "&wallet_id="
				+ wallet_id;
	...
	public static Map GetBetDetail(Long version_key, String options) {
		String parameters = "vendor_id=" + VENDOR_ID + "&version_key=" + version_key + "&options=" + options;
