...
public class CommissionsId implements java.io.Serializable {
	...
	/** default constructor */
	public CommissionsId() {
	}

	/** full constructor */
	public CommissionsId(String loginname, Integer year, Integer month) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CommissionsId))
			return false;
		CommissionsId castOther = (CommissionsId) other;
	...
	public String toString() {
		return "CommissionsId [loginname=" + loginname + ", month=" + month + ", year=" + year + "]";
	}
