 ...
 */
@Entity
@Table(name = "guestbook", catalog = "tianwei")
...
public class Guestbook implements java.io.Serializable {
	...
	/** minimal constructor */
	public Guestbook(Integer flag, String ipaddress, String createdate,
	...
	public Guestbook(Integer referenceId, Integer flag, Integer rcount,
			...
			String qq, String createdate, String title, String content) {
