...
public class ZookeeperFactoryBean implements FactoryBean, InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		zkClient = createWithOptions(Configuration.getInstance().getValue("zk.conn.url"), retryPolicy, 2000, 10000);
