...
public class PTBigBang implements Serializable {
	...
	private Date startTime;             //开始时间（整点数）
	private Date endTime;               //结束时间（整点数）
	...
	private String tempDistributeTime;
	
	@Transient
	public String getTempDistributeTime() {
		return tempDistributeTime;
	}
	public void setTempDistributeTime(String tempDistributeTime) {
		this.tempDistributeTime = tempDistributeTime;
	}
