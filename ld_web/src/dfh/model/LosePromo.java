...
public class LosePromo implements Serializable{
	...
	public LosePromo(String username, double amount, double deduct, double rate, double promo, int times, String status, double betting, Date createTime, String promoDate, String platform, String pno){
