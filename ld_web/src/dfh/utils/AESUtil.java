...
public class AESUtil {
	...
	private static final String PAY_CENTER_KEY = "ule&Jdos8doUd3DB";
    ...
    public static String encrypt(String src) throws Exception {
        ...
        encrypt = new String(Base64.encodeBase64(encrypted));
        return encrypt;
    }
	...
	public static void main(String[] args) throws Exception {
		String content = "我爱你5454534@qq.com";
//		String content = "13898989898";
		...
		String encrypt1 = aesEncrypt(content, KEY);
		System.out.println("加密后：" + encrypt1);
		
		String decrypt1 = aesDecrypt("asdas", KEY);
		System.out.println("解密后：" + decrypt1);
		
		System.out.println(encrypt.equals(encrypt1));
		
		System.out.println(dfh.utils.StringUtil.isNumeric("09021_9398219"));;
	}
}
