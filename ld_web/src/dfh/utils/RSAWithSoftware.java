...
public class RSAWithSoftware
{
  ...
  public static void main(String[] args) {
	  String signInfo = "bank_seq_no=7551102936201603170245277390&extra_return_param=woodytest_flag_ZFWX&interface_version=V3.0&merchant_code=2000295500&notify_id=b02a32d7665e4eb0ba5c40853bea98d9&notify_type=offline_notify&order_amount=1&order_no=woodytest_qy1676470&order_time=2016-03-17 01:29:15&trade_no=1120190487&trade_status=SUCCESS&trade_time=2016-03-17 13:29:15";
	try {
		String dinSign = "XfOqIoYTKSz1AaDcSv82thtTwWNixU7rua0yrtVx7mBRZlfI13okhoyI7Gy0SpekNWSOr5Y+r90eUKPaeQrT6JgfJxKVFsBF5BCegDDvHIdd+QsK/k73UpIa1Js3HcFw5R/+jDSWzA3HBUruX4u8jzeyJ5hNagxE314gsagaLK0=";
		System.out.println(signInfo);
		Boolean flag = validateSignByPublicKey(signInfo, ZfWxSendRequestUtil.ZF_PUBLIC_KEY, dinSign);
//		String mysign = encryptByPublicKey(singInfo, ZfWxSendRequestUtil.ZF_PUBLIC_KEY) ;
