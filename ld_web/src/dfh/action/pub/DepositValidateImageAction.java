...
public class DepositValidateImageAction extends SubActionSupport {
	...
	public DepositValidateImageAction() {
	...
	public String execute() throws Exception {
		...
		getHttpSession().setAttribute(Constants.USER_DEPOSIT,null);
		...
		getHttpSession().setAttribute(Constants.USER_DEPOSIT, sRand);
		g.dispose();
