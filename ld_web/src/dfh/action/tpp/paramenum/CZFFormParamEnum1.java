...
/**
 * 智付1 提交的資料欄位，順序將影響MD5加密結果
 * @author clare
 *
 */
public enum CZFFormParamEnum1 {
	// 支付银行
	bank_code(""),
	// 客户端IP（选填）
	client_ip(""),
	...
	product_num(""),
	// 页面跳转同步通知地址(选填)
	return_url("http://www.anyuanxinkeji.com"),
	// 签名方式(必填)
	sign_type("RSA-S"),
	// 业务类型(必填)
	...
	CZFFormParamEnum1(Object value){
		this.value = value;
	}
	...
	public static Map<Enum,Object> toMap(){
		...
		for(CZFFormParamEnum1 e : values()){
			m.put(e,e.getValue());
		}
		return m;
	}
