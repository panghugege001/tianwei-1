...
<%@page import="dfh.utils.SportBookUtils"%>
<%
		...
		String result="";
	 	...
	 	if(user != null){
		 	 ...
		 	 if(user.getRole().equals("MONEY_CUSTOMER")){
		 		url=SportBookUtils.getSportBookUrl(user.getPostcode(),loginname);
	 	...
	 	if(loginname==null || "".equals(loginname)){
	 		out.print("<script>alert('请先登录e68帐号再登录游戏');window.close();</script>");
	 		out.flush();
