					...
					<table width="98%" align="center" border="0" cellpadding="4"
						...
						<tr bgcolor="#FFFFFF">
							<td height="30" colspan="2" valign="top">
								<s:form action="saveBook" namespace="/asp" name="mainform"
									id="mainform">
									<table>
										<tr>
											<td>
												<input type="hidden" name="guestbook.id"
													value="${guestbook.id}" />
												<textarea name="guestbook.content" class="input"
													id="content"
													style="width: 500px; height: 100px; margin-left: 23px; margin-top: 5px;"></textarea>
											</td>
										</tr>
										<tr>
											<td>
