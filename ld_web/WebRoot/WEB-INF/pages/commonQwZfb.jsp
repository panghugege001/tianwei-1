...
<html>
	...
	<div class="pay-page">
		...
		<div class="pay-online-wp"  id="pay-online-wp">
			...
			<form id="dinpayRedirect" action="${ctx}/asp/QwZfRedirect.aspx" method=post
				...
				<table class="account-info table-pay">
					...
					<tr>
						...
						<td>
							...
							*必选&nbsp;&nbsp;<span style="color: red;">(保留两位小数点 如：10.10)</span>
						</td>
					</tr>
					<tr>
						<th>
