			...
			<form id="dinpayRedirect" action="${ctx}/asp/pay_api.aspx" method=post name="dinpayRedirect" id="dinpayRedirect">
				...
				<table class="account-info table-pay">
					<tbody>
						...
						<tr>
							<th>存款额度：</th>
							<td><input class="input" name="orderAmount" id="amount" type="text" maxlength="10"/>*必选</td>
						</tr>
						<tr>
							<th>支付银行：</th>
							<td>
								<select name="payCode" id="bankco" class="input">
									<option value="22">支付宝支付</option>
								</select>
								*必选
							</td>
						</tr>
						<tr>
							<td></td>
							<td colspan="2" align="left"><input name="Submit" type="button" class="btn btn-danger" onclick="return btnOK_zf_onclick();" value="确定支付" />&nbsp;&nbsp;</td>
						</tr>
						<tr>
							<td colspan="2">温馨提示：为了避免掉单情况的发生，请您在支付完成后，需等“支付成功”页面跳转出来，点击<input name="Submit22" type="button" class="pay-tip warning" value="商城取货" />或<input name="Submit2" type="button" class="pay-tip danger" value="通知客户" />，再关闭页面,以免掉单！感谢配合！！！</td>
						</tr>
					</tbody>
				</table>
			</form>
