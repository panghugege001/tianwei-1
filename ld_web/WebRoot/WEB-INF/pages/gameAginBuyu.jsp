    ...
    <div class="index-bg">
        ...
        <div id="content_bg"
            ...
            <label style="color: yellow;">
                <a href="${ctx}/gameAginBuyuRedirect.aspx" target=" _blank" style="color: yellow;font-size: 20px;">全屏游戏</a>
            </label>
        </div>
        <div style="width: 1024px;margin:0 auto;">
            <iframe name="ifrm" id="ifrm"
                    src="${ctx}/gameAginBuyuRedirect.aspx" frameborder="0" marginwidth="0"
