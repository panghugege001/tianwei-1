...
<div class="pay-page">
	...
	<div class="pay-online-wp">
		...
		<form id="dinpayRedirect" action="${ctx}/asp/YfRedirect.aspx" method=post name="dinpayRedirect" id="dinpayRedirect">
			...
			<table class="account-info table-pay">
				...
				<tr>
					...
					<td>
						<div class="ipt-group">
							<select name="payCode" id="bankco" class="ipt-txt">
								<option value="ZF_WX">
									微信支付
								</option>
							</select>
