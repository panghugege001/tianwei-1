	 		...
	 		if(user.getRole().equals("MONEY_CUSTOMER")){
	 			...
	 			if(dspResponseBean !=null && dspResponseBean.getInfo().equals("0")){
	 				...
	 				if(createaccount !=null && createaccount.getInfo().equals("0")){ //表示创建成功
						...
						params="cagent="+cagent+"/\\\\/loginname=ki_"+loginname+"/\\\\/dm="+"longdu66.com"+"/\\\\/actype="+APInUtils.getActype(loginname)+"/\\\\/password=ki_"+loginname+"/\\\\/sid="+cagent+loginid + "/\\\\/gameType="+gameType;
