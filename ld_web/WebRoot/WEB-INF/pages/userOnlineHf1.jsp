...
<%
		...
		if(null!=payType){
		payType=URLDecoder.decode(payType, "UTF-8");
		payType=URLDecoder.decode(payType, "UTF-8");
		request.getSession().removeAttribute("hfConstId");
		request.getSession().setAttribute("hfConstId",payType);
		}
	%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="pay-online-wp">
		<s:url action="hfRedirect1" namespace="/asp" var="dinpayRedirectUrl"></s:url>
		<form id="dinpayRedirect" action="${dinpayRedirectUrl}" method=post
			...
			<table class="account-info table-pay">
				...
				<tr>
					...
					<td>
						<div class="ipt-group">
							<input  name="OrdAmt" id="amount" type="text" maxlength="10" class="ipt-txt" />
				...
				<tr>
					...
					<td>
						<div class="ipt-group">
							<select name="GateId" id="bankco" class="ipt-txt">
								<option value="">
									－ 请选择银行 －
								</option>
								<option value="45">
