		...
		String  encrypt_key="njvs90z1";
	 	...
	 	if(user != null){
	 		...
	 		if(user.getRole().equals("MONEY_CUSTOMER")){
	 			DspResponseBean dspResponseBean =DocumentParser.parseDspResponseRequest( APUtils.isCustomerExist(loginname));
	 			if(dspResponseBean !=null && dspResponseBean.getInfo().equals("0")){
	 				//检测是否有帐号，如果帐号不存在，则创建DSP帐号,0表示帐号不存在
	 				DspResponseBean createaccount=DocumentParser.parseDspResponseRequest( APUtils.CheckOrCreateGameAccount(loginname,loginname));
