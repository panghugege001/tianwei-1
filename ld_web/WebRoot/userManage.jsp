	...
	<div class="index-bg about-bj">
		...
		<div class="container w_357">
				...
				<div class="gb-main-r tab-bd user-main">
					...
					<div id="tab_withdraw" class="user-tab-box tab-panel">
						<div class="qukuang_box">
							<ul>
								<li class="active"><a href="#qukuang" data-toggle="tab"
									aria-expanded="true">我要提款</a></li>
								<li><a href="#yinhangka" data-toggle="tab"
									aria-expanded="true">我的银行卡</a></li>
								<li><a data-toggle="tab" id="triggerSet"
									href="#tab-setpaypass">设置提款密码</a></li>
								<!--                             <li>
						...
						<div class="tab-panel active" id="qukuang">
							<form method="post" id="requestform" action="" name="checkform"
								class="userform ui-form">
								<input type="hidden" id="accountName"
									value="${session.customer.accountName}" />
								<div class="ui-form-item">
									<label class="ui-label" for="ipt_username">天威账户：</label> <span
										class="span_name">${customer.loginname }</span> <label
										class="user_lable">账户余额：</label> <span class="u_money">${customer.credit}元</span>
								</div>
								<div class="ui-form-item">
									<label class="ui-label" for="ipt_password">帐户密码：</label>
									<%--防止自动填充--%>
									<input type="password" style="display: none;" /> <input
										name="password" id="mar_password" placeholder="游戏账户登录密码"
										class="ui-ipt" type="password">
								</div>
								<div class="ui-form-item">
									...
									<select id="bank" name="bank"
										onchange="getWithDrawBankNo(this.value)">
										<option>请选择</option>
									</select>
								...
								<div class="ui-form-item">
									<label class="ui-label" for="accountNo">银行卡号：</label> <input
										id="accountNo" name="accountNo" placeholder="请输入正确银行卡号/钱包地址"
										class="ui-ipt" type="text" value="" readonly>
									<!--                            <a href="/manageData.jsp?card_binding" class="link cee6">绑定卡号</a>-->
								</div>
								<div class="ui-form-item" style="display: none">
									<label class="ui-label" for="bankAddress">开户银行：</label> <input
										type="text" class="ui-ipt" name="bankAddress" id="bankAddress"
										readonly>
								</div>

								<div class="ui-form-item">
									<label class="ui-label" for="mar_amount">取款金额：</label> <input
										id="mar_amount" name="amount" placeholder="请输入金额"
										class="ui-ipt" type="text" value="">
								</div>

								<div class="ui-form-item j_questionflag" style="display: none;">
									<label class="ui-label" for="mar_questionid">密保问题：</label>
									<s:select id="mar_questionid" name="questionid"
										list="%{#application.QuestionEnum}" cssClass="ui-ipt"
										listKey="code" listValue="text"></s:select>

								</div>
								<div class="ui-form-item j_questionflag">
									<label class="ui-label" for="mar_answer">取款密码：</label> <input
										style="width: 200px" id="mar_answer" placeholder="请输入您的取款密码"
										class="ui-ipt" type="password"> <input
										class="btn btn-danger user-btn-mod"
										onclick="$('#triggerSet').trigger('click')" type="button"
										style="position: relative; bottom: 4px;" value="设置提款密码">
								</div>
                            ...
                            --%>
								...
								<div class="ui-form-item">
									<label><input type="checkbox" value="male" name="agree"
										checked="checked">我已经读过 <a class=""
										style="color: #50588c;" target="_blank"
										href="/aboutus.jsp#tab-agreement">《提款须知》</a>，并已清楚了解其规则。</label>
								</div>
								<div class="user_qukuang">
									<input class="btn" type="button" id="J_btn_draw"
										onclick="return tkConfirm()" value="确认提交">
								</div>
							</form>
							<div class="prompt-info" style="padding-left: 165px;">
								<h3 class="tit c-huangse">温馨提示</h3>
								<p>
									1.提款验证以天威账号金额为基准，游戏账户的提款需要转账到天威账户。<br /> 2.中午11:50 -
									14:00,AG后台结算时间提款会顺延到 14:00 后审批出款，谢谢配合。<br />
						...
						<div class="tab-panel" id="yinhangka">
							<ul class="user_bank">
								<li class="add_bank"><a href="javascript:;"
									class="bangding" style="display: inline-block;"><img
										src="images/user/add_back.jpg" /></a></li>
                    ...
                    <a href="javascript:void(0)" class="disFlag" id="sendAlipayPhoneCodeBtn">短信验证</a>
						...
						<div id="tab-setpaypass" class="user-tab-box tab-panel">
							<input type="text" id="noPayPassword" hidden
								value="${session.payPassword == null}">
							<form id="passwordPayform" class="ui-form" method="post">
								<c:if test="${session.payPassword == null}">
									<div class="ui-form-item">
										<label class="ui-label rq-value">登录密码：</label> <input
											type="password" class="ui-ipt" name="password"
											id="loginPassWord" placeholder="" autocomplete="off" required />
										<span class="ipt-tip">*请输入登录密码</span>
									</div>

									<div class="ui-form-item">
										<label class="ui-label rq-value">取款密码：</label> <input
											type="password" class="ui-ipt" id="newPayPassWord"
											autocomplete="off" name="new_content" placeholder="" required />
								...
								<c:if test="${session.payPassword != null}">
									<div class="ui-form-item">
										<label class="ui-label rq-value">取款密码：</label> <input
											type="password" class="ui-ipt" name="content"
											id="oldPayPassWord" placeholder="" autocomplete="off"
											required /> <span class="ipt-tip">*请输入取款密码</span>
									</div>
									<div class="ui-form-item">
										<label class="ui-label rq-value">新取款密码：</label> <input
											type="password" class="ui-ipt" id="newPayPassWord"
											autocomplete="off" name="new_content" placeholder="" required />
								...
								<div class="ui-form-item">
									<input type="submit" class="btn btn-danger user-btn-mod"
										value="提交" onclick="return updateDatePayPassword()">
								</div>
							</form>
					...
					<div id="tab_transfer" class="user-tab-box tab-panel">
						<div class="zhuanzhang">
							<ul>
								<li class="active"><a href="#tab-onetransger"
									data-toggle="tab" aria-expanded="true">转账</a></li>
								<li><a href="#tab-redpacket" data-toggle="tab"
									aria-expanded="true">红包转账</a></li>
							</ul>
						</div>
						<div class="tab-panel active" id="tab-onetransger">
							<div class="zhuanzhang_box">
								<form method="post" name="form1" class="ui-form">
									<div class="ui-form-item">
										<label class="ui-label" for="">来源账户：</label> <select
											name="source_acc" id="transferGameOut" class="ui-ipt"
                                        ...
                                        --%>
										</select> <span id="transferMoneryOutDiv" class="c-red">加载中..</span>
									</div>
									<div class="ui-form-item">
										<label class="ui-label" for="">目标账户：</label> <select
											name="target_acc" id="transferGameIn" class="ui-ipt"
											onchange="transferMoneryIn(this.value);">
											<option value="dt" selected>DT账户</option>
                                        ...
                                        <option value="ebetapp">EBet真人账户</option>
                                        --%>
										</select> <span id="transferMoneryInDiv" class="c-red">加载中..</span>
									</div>
									...
									<div class="ui-form-item">
										<label class="ui-label" for="">转账金额：</label> <input
											id="transferGameMoney" class="ui-ipt" maxlength="10"
											type="text" /> <span class="c-red">请输入转账金额</span>
									</div>
									<div class="ui-form-item">
										<input type="button" class="btn yes_tijiao"
											onclick="return transferMonery();" value="提交"
											style="margin-left: -25px;" /> <input type="button"
											class="btn yes_huigui" value="一键额度回归"
											onclick="onekeyMonery();" style="margin: 0 0 0 26px">
							...
							<div class="prompt-info">
								<h3 class="tit c-huangse">温馨提示：</h3>
								<p>1.老虎机账户"支持BBIN、DT、MG、CQ9、PG，若要游玩以上平台请将额度转入游戏平台账户即可。</p>
						...
						<div class="tab-panel" id="tab-redpacket">
							<div class="zhuanzhang_box ">
								...
								<div class="ui-form-item">
									<label class="ui-label" for="">来源账户：</label> <select
										id="redRainOut" onchange="redRainMoneryOut(this.value);"
										class="ui-ipt">
										<option value="self" selected="selected">天威账户</option>
										<option value="redrain">红包账户</option>
									</select> <span id="redRainOutDiv" class="c-red">0.0元</span>
								</div>
								<div class="ui-form-item">
									<label class="ui-label" for="">目标账户：</label> <select
										id="redRainIn" onchange="redRainMoneryIn(this.value);"
										class="ui-ipt">
										<option value="">请选择目标帐户</option>
										<option value="redrain">红包账户</option>
									</select> <span id="redRainInDiv" class="c-red">请选择账户!</span>
								</div>
								<div class="ui-form-item">
									<label class="ui-label" for="">转账金额：</label> <input type="text"
										class="ui-ipt" id="redRainMoney" maxlength="10">
								</div>
								<div class="ui-form-item">
									<input type="button" onclick="return redRainMonery();"
										class="btn yes_tijiao" value="执行转账">
								</div>
					...
					<div id="tab-friends" class="user-tab-box tab-panel">
						<div class="friends_box">
							<ul>
								<li class="active"><a href="#tuijian-friends"
									data-toggle="tab" aria-expanded="true">推荐好友</a></li>
								<li><a href="#record-hy" id="friends-records-action"
									data-toggle="tab" aria-expanded="true"
									data-href="/asp/queryfriendRecord.aspx">推荐记录</a></li>
							</ul>
						</div>
						<div id="tuijian-friends" class="tab-panel active">
							<div class="ui-form" style="min-height: 400px;">
								...
								<div class="link-box">
									...
									<a href="javascript:;" class="link" id='friendurl'></a> <a
										href="javascript:;" class="btn-sm url-btn"
								...
								<div>活动规则：</div>
								<div class="tab-content2 tab-item-con active"
									style="padding: 20px;">
						...
						<div id="record-hy" class="page tab-panel record">
							<iframe src="" width="100%" height="780" border="0"
								scrolling="no" frameborder="0" allowtransparency="true"
								class="if-record"> </iframe>
						</div>
					</div>
					<!--}推荐好友-->
					...
					<div id="tab-youhui" class="user-tab-box tab-panel">
						<div class="youhui_mull">
							<ul>
								<li class="active"><a data-toggle="tab" href="#tab-pt2">体验金</a>
								</li>
								<li class=""><a data-toggle="tab" href="#tab-persent">自助存送</a>
								</li>
								<li><a data-toggle="tab" href="#tab-help"
									onclick="losePromoRecord(1);">救援金</a></li>
								<li><a data-toggle="tab" href="#tab-return"
									onclick="getXimaEndTime($('#platform').val());">自助返水</a></li>
								<li><a data-toggle="tab" href="#tab-level"
									data-url="/asp/queryBetOfPlatform.aspx"
									onclick="loadIframe(this);">自助晋级</a></li>
								<li><a data-toggle="tab" href="#tab-coupon">优惠券专区</a></li>
								<li><a data-toggle="tab" href="#tab-chouma">免费筹码</a></li>
								<li><a data-toggle="tab" href="#tab-birthday">生日礼金</a></li>
							</ul>
						</div>
							...
							<div class="birthday-box">
								...
								<div class="birthday-body">
									...
									<div class="birthday-succes">
										<div class="item">
											<span class="s-title">会员生日：</span> <b class="input"
												id="birthday-birth">...</b> <a class="birthday-user-right"
												id="draw-record">领取记录</a>
										</div>
										<div class="item">
											<span class="s-title">会员等级：</span> <b class="input"
												id="vip-grade">。。。</b>
										</div>
										<div class="item">
											<span class="s-title" style="position: relative; top: -58px;">生日礼金：</span>
											<div class="ticket">
						...
						<div id="tab-pt2" class="user-tab-box active tab-panel">
							...
							<div class="tab-bd">
								<div class="tab-panel active">
									<div class="ui-form-item">
										<label class="ui-label">用户昵称：</label> <input type="text"
											class="ui-ipt" value="${customer.loginname}"
											disabled="disabled">
									</div>
									<div class="ui-form-item">
										<label class="ui-label">真实姓名：</label> <input type="text"
											class="ui-ipt"
									...
									<div class="ui-form-item">
										<label class="ui-label">注册IP：</label> <input type="text"
											class="ui-ipt" value="${customer.registerIp}"
											disabled="disabled">
									</div>
									<div class="ui-form-item">
										<label class="ui-label">此次登录IP：</label> <input type="text"
											class="ui-ipt" value="${customer.lastLoginIp}"
											disabled="disabled">
									</div>
									<div class="ui-form-item">
										<a href="javascript:void(0);" class="btn btn-pay pt8next"
											data="1" title="下一步">下一步</a>
									</div>
								</div>
								<div class="tab-panel fade">
									...
									<form id="phoneCheckValid">
										...
										<div class="next-box1 ui-form">
											<div class="ui-form-item">
												<label for="" class="ui-label">电话号码：</label> <input
													type="text" name="aliasName" class="ui-ipt"
													value='<s:property value="@dfh.utils.StringUtil@subStrBefore(#session.customer.phone, 6)+'
                                                   ***** '" />'
													disabled="disabled">
											</div>
											<div class="ui-form-item">
                                               ...
                                               style="">语音验证</a> -->
												<a href="javascript:;" class="btn btn-danger"
													id="sendPhoneCodeBtn" style="">短信验证</a>
											</div>
											<div class="ui-form-item">
												<label for="" class="ui-label">输入验证码：</label> <input
													type="text" id="phoneCode" class="ui-ipt">
											</div>
											<div class="ui-form-item">
												<a href="javascript:void(0);" class="btn btn-danger pt8next"
													data="2" title="下一步">下一步</a>
											</div>
										</div>
										<div class="next-box2 unis prompt-info">
											<h3 class="tit c-red">温馨提示</h3>
											<p id="_valideteTextId">1.短信安全验证(请用您注册时的手机号码发送短信
												#(1)到#(2))</p>
											<p>
												2.短信发送成功,<span class="c-red">请于15秒后点击"下一步"</span>
											</p>
											<p>
												3.必须使用<span class="c-red">注册时填写的手机号码</span>进行发送短信!
											</p>
											<div class="ui-form-item">
												<a href="javascript:void(0);" class="btn btn-pay pt8next"
													data="2" title="下一步">下一步</a>
										...
										<div class="wrap">
											<div id="captcha-target"
												style="display: inline-block; width: 339px;"></div>
										</div>
									</form>
								</div>
								<div class="tab-panel fade">
									<div class="ui-form">
										<div class="ui-form-item">
											<label class="ui-label">开户行：</label> <select id="pt8_bank"
												name="" style="height: 38px;"
										...
										<div class="ui-form-item">
											<label class="ui-label">银行卡号：</label> <input type="text"
												id="yhBankNo" name="yhBankNo" class="ui-ipt"
												disabled="disabled">
										</div>
										<div class="ui-form-item">
											<a href="javascript:void(0);" class="btn btn-pay pt8next"
												data="3" title="下一步">下一步</a>
										</div>
									</div>
									...
									<div class="ui-form">
										<div class="ui-form-item">
											...
											<label><input type="radio" name="myslotchoice"
												value="PT" checked="checked"><span>PT</span></label> <label><input
												type="radio" name="myslotchoice" value="MG"><span>MG</span></label>
											<label><input type="radio" name="myslotchoice"
												value="DT"><span>DT</span></label> <label><input
												type="radio" name="myslotchoice" value="TTG"><span>TTG</span></label>
											<label><input type="radio" name="myslotchoice"
												value="NT"><span>NT</span></label> <label><input
												type="radio" name="myslotchoice" value="QT"><span>QT</span></label>
											<a href="javascript:void(0);" class="btn btn-pay pt8sub"
												id="sub" title="确定">确定</a>
										</div>
									</div>
							...
							<div class="tab-bd">
								<div id="tab-coupon1" class="tab-panel active">
									<div class="user-tab-box" style="margin: 0;">
										<div class="zizhucunsog_box">
											<form class="userform" action="transferInforCoupon"
												id="transferform" name="transferInForm" method="post"
												onsubmit="return submitRemit()">
												<div class="ui-form-item">
													<label class="ui-label">从天威账户转账到</label> <select
														class="ui-ipt" id="platform">
												...
												<div class="ui-form-item">
													<label class="ui-label">存款金额：</label> <input type="text"
														class="ui-ipt" style="font-weight: bold;"
														name="couponRemit" id="couponRemit" />
												</div>

												<div class="ui-form-item">
													<label class="ui-label">优惠代码：</label> <input type="text"
														class="ui-ipt" name="couponCode" id="couponCode" />
												</div>
								...
								<div id="tab-coupon2" class="tab-panel">
									<div class="user-tab-box">
										<div class="zizhucunsog_box">
											<form class="userform" class="ui-form"
												action="transferInforRedCoupon" id="transferRedform"
												name="transferInRedForm" method="post"
												onsubmit="return submitRedCouponRemit()">

												<div class="ui-form-item">
													<label class="ui-label">优惠代码：</label> <input type="text"
														class="ui-ipt" name="redcouponCode" id="redcouponCode" />
												</div>

												<div class="ui-form-item">
													<label class="ui-label">从天威账户转账到</label> <select
														class="ui-ipt" id="redcouponType" name="redcouponType">
														<option>--请选择平台--</option>
														<option value="ttg">TTG</option>
														<option value="pt">PT</option>
														<option value="nt">NT</option>
						...
						<div id="tab-chouma" class="user-tab-box tab-panel">
							...
							<div class="zizhucunsog_box">
								<form class="ui-form" action="" method="post">
									<div class="ui-form-item">
										<label class="ui-label">会员等级：</label> <input type="text"
											class="ui-ipt" readonly
											value="<s:property value="
                                           @dfh.model.enums.VipLevel@getText(#session.customer.level) "/>">
									</div>

									<div class="ui-form-item need-hide" style="display: none;">
										<label class="ui-label">目标账户：</label> <select
											id="j-chipPaltform" class="ui-ipt">
            ...
            <option value="PNG">PNG</option> -->
									...
									<div class="ui-form-item">
										<label class="ui-label">筹码金额：</label> <input id="moneyVal"
											type="text" class="ui-ipt" readonly value="">
									</div>
									<div class="user_tijiao">
										<input type="button" class="btn" value="立即领取"
											onclick="getFreeChip()">
									</div>
									<div class="prompt-info p_120">
										<h3 class="tit c-huangse">温馨提示：</h3>
						...
						<div id="tab-persent" class="user-tab-box tab-panel">
							<h1 class="tab-tit">
								自助优惠 ><span class="cee6"> 自助存送</span>
							</h1>
							<s:url action="execXima" namespace="/asp" var="execXimaUrl"></s:url>
							<div class="zizhucunsog_box">
								<input type="button" class="btn bcbs-btn" value="笔存笔送"
									id="openBcbsModal" />
								<form class="ui-form" id="selform" action="${execXimaUrl }"
									method="post" onsubmit="return checkSubmit()">
									<div class="ui-form-item">
										<label class="ui-label">选择平台：</label> <select class="ui-ipt"
											onchange="youHuiNameChange(this.value);" id="youhuiName">
									...
									<div class="ui-form-item">
										<label class="ui-label">优惠类型：</label> <select
											name="youhuiType" id="youhuiType" class="ui-ipt"
									...
									<div class="ui-form-item">
										<label class="ui-label">转账金额：</label> <input type="text"
											class="ui-ipt" name="transferMoney" id="transferMoney"
											onkeyup="clearNoNum(this);"
											onblur="getSelfYouhuiAmount(this.value);" />
									</div>

									<div class="ui-form-item">
										<label class="ui-label">红利金额：</label> <input type="text"
											class="ui-ipt" name="giftMoney" id="giftMoney" readonly />
									</div>

									<div class="ui-form-item">
										<label class="ui-label">流水倍数：</label> <input type="text"
											class="ui-ipt" style="margin-top: 5px;" name="waterTimes"
								...
								<div id="bcbsTable" class="bcbs-table">
									...
									<input type="button" class="btn bcbs-btn" value="关闭弹窗"
										id="closeBcbsModal" />
								</div>
							</div>
						</div>
						...
						<div id="tab-caijin" class="user-tab-box tab-panel">
							...
							<div class="fl box-hd">
								<p>
									IOS系统下载<br /> 下载方法：【1】<br /> 使用手机二维码扫描软件扫码下载
								</p>
								<div>
									<img src="/images/appxiazai/longduapp.png" />
								</div>
								<p>
									下载方法：【2】<br /> 手机任意浏览器输入网址<br /> www.tianwei4.com
								</p>
							</div>
							<div class="fl box-hd">
								<p>
									Android系统下载<br /> 下载方法：【1】<br /> 使用手机二维码扫描软件扫码下载
								</p>
								<div>
									<img src="/images/appxiazai/longduapp.png" />
								</div>
						...
						<div id="tab-return" class="user-tab-box tab-panel">
							...
							<div class="zizhucunsog_box">
								<s:url action="execXima" namespace="/asp" var="execXimaUrl"></s:url>
								<form class="ui-form" id="selform2" action="${execXimaUrl }"
									method="post" onsubmit="return checkSubmit()">
									<div class="ui-form-item">
										<label class="ui-label">游戏平台：</label> <select class="ui-ipt"
											id="platform2">
											<option value="pttiger">PT</option>
											<option value="ttg">TTG</option>
											<option value="slot">老虎机账户(SW,MG,DT,PNG,QT,NT)</option>
									...
									<div id="otherList">
										<div class="ui-form-item">
											<label class="ui-label" for="startTime">起点时间：</label> <input
												type="text" class="ui-ipt" readonly name="startTime"
												id="startTime" />
										</div>

										<div class="ui-form-item">
											<label class="ui-label" for="endTime">截止时间：</label> <input
												type="text" class="ui-ipt" name="endTime" id="endTime" />
										...
										<div class="ui-form-item">
											<label class="ui-label" for="validAmount">有效投注额：</label> <input
												type="text" class="ui-ipt" name="validAmount"
												id="validAmount" readonly />
										</div>

										<div class="ui-form-item">
											<label class="ui-label" for="rate">返水比率：</label> <input
												type="text" class="ui-ipt" name="rate" id="rate" readonly />
										</div>

										<div class="ui-form-item">
											<label class="ui-label" for="ximaAmount">返水金额：</label> <input
												type="text" class="ui-ipt" name="ximaAmount" id="ximaAmount"
												readonly />
										</div>
										<div class="user_tijiao">
											<input type="button" class="btn" value="提交"
												onclick="return checkEaSubmit();" />
										</div>
									</div>
									<div id="slotList" style="display: none;">
										<table class="tb-datalist tb-form userTable mt30" width="100%"
                                      ...
                                      <tr>
										...
										<input class="nextBtn btn btn-danger zizhusw" type="button"
											value="领取" onclick="return newExecXimaSubmit();"
											style="margin-left: 0">
									</div>
									<div class="prompt-info p_120">
						...
						<div id="tab-level" class="user-tab-box tab-panel">
							<h1 class="tab-tit">
								自助优惠 ><span class="cee6"> 自助晋级</span>
							</h1>
						...
						<div id="tab-ptcrazy" class="user-tab-box tab-panel">
							<h1 class="tab-tit">
								自助优惠 ><span class="cee6"> PT疯狂礼金领取</span>
							</h1>
						...
						<div id="tab-checkin" class="user-tab-box tab-panel">
							<h1 class="tab-tit">
								自助优惠 ><span class="cee6"> 每日签到</span>
							</h1>
							<div class="ui-form">
								<div class="ui-form-item">
									<label for="" class="ui-label">签到奖金账户余额：</label> <span
										class="c-red" id="qdmoney1"></span>
								</div>
								<div class="ui-form-item">
									<label for="" class="ui-label">签到奖金账户：</label> <select
										class="ui-ipt" id="signType">
										<option value="">请选择</option>
										<option value="ttg">TTG</option>
										<option value="pt">PT</option>
										<option value="nt">NT</option>
								...
								<div class="ui-form-item">
									<label for="" class="ui-label">签到金额：</label> <input type="text"
										class="ui-ipt" id="signRemit">
								</div>
								<div class="ui-form-item">
									<a href="javascript:;" class="btn btn-pay"
										onclick="return submitSignRemit();">提交</a>
								</div>
							</div>
						...
						<div id="tab-point" class="user-tab-box tab-panel">
							<h1 class="tab-tit">
								自助优惠 ><span class="cee6"> 积分中心</span>
							</h1>
							<div class="ui-form">
								<div class="ui-form-item">
									<label for="" class="ui-label">可用积分：</label> <span
										class="c-red" id="friendPoint"></span>
								</div>
								<div class="ui-form-item">
									<label for="" class="ui-label">历史总积分：</label> <span
										class="c-red" id="totalfriendPoint"></span>
								</div>
								<div class="ui-form-item">
									<label for="" class="ui-label">当前兑换比率：</label> <span
										class="c-red"> <c:if
											test="${session.customer.level==0}">500积分兑换1元</c:if> <c:if
											test="${session.customer.level==1}">400积分兑换1元</c:if> <c:if
											test="${session.customer.level==2}">325积分兑换1元</c:if> <c:if
											test="${session.customer.level==3}">280积分兑换1元</c:if> <c:if
											test="${session.customer.level==4}">245积分兑换1元</c:if> <c:if
											test="${session.customer.level==5}">220积分兑换1元</c:if> <c:if
											test="${session.customer.level==6}">100积分兑换1元</c:if> ;可兑换奖金为：<span
										id='moneypoint'></span>
									</span>
								</div>
								<div class="ui-form-item">
									<label for="" class="ui-label">积分兑换奖金到天威账户：</label> <input
										type="text" id="pointRemit" class="ui-ipt"><span
										class="c-red">请输入兑换金额</span>
								</div>
								<div class="ui-form-item">
									<a href="javascript:;" class="btn btn-pay"
										onclick="return submitPointRemit();">提交</a>
								</div>
							</div>
                ...
                --%>
					...
					<div id="tab_mrrw" class="user-tab-box tab-panel">
						<ul class="tab-muen-item clearfix user_mull" id="user_mull">
							<li class="active"><a href="#tab-user" data-toggle="tab">每日签到</a>
							</li>
							<li><a href="#tab-money" data-toggle="tab"
								aria-expanded="false">存款红包</a></li>
							<!-- <li>
												...
												<div class="qiandao-left">
													<div class="qiandao_top">
														<p style="font-size: 16px;">
															签到余额:<span id="todayGet" class="todayGet"
													...
													<div class="qiandao-bottom">
														<h3>温馨提示</h3>
														<p style="color: #FFFFFF;">累计签到7日，并达到每日存款要求，
															即可领取红包存送优惠券。</p>
							...
							<div class="form_box meirhb">
								<form method="post" name="form2" style="font-size: 14px;">
									<table border="0" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td>红包类型：</td>
											<td><select id="hbSelect" name="hbSelect" class="input">

											</select></td>
											<td class="sub" id="lingqu"><input type="button"
												value="领取红包" onclick="return doHB();" /></td>
										</tr>
										<tr>
											<td>红包使用：</td>
											<td><select id="hbType" name="hbType" class="input">
													<option value="0" selected="selected">请选择</option>
													<option value="pt">PT</option>
													<option value="ttg">TTG</option>
													<option value="slot">老虎机账户(SW,MG,DT,PNG,QT,NT)</option>
										...
										<tr>
											<td colspan="2" class="sub" id="tijiao"
												style="padding-top: 30px;"><input type="button"
												onclick="return submitHBRemit();" class="mt10" value="提交"
												style="margin-left: 180px; padding: 0 50px;"></td>
										</tr>
									</table>
								</form>
								<p class="p_style">
									<span class="c-huangse">温馨提示:</span><br /> 1.同时段红包只能领取一类红包 <br />
									2.满10元可以转到任意的平台，需5倍流水
								</p>
							</div>
						</div>
						<div id="tab-cunsong" class="tab-panel tab_box">
							<form class="ui-form" style="font-size: 14px;">
								<div class="ui-form-item">
									<label class="ui-label">存送优惠类型：</label> <select
										name="youhuiType" id="youhuiType1" class="ui-ipt"
								...
								<div class="ui-form-item">
									<label class="ui-label">转账金额：</label> <input class="ui-ipt"
										type="text" name="transferMoney" id="transferMoney1"
										onblur="getSelfYouhuiAmount1(this.value);" />
								</div>

								<div class="ui-form-item">
									<label class="ui-label">红利金额：</label> <input class="ui-ipt"
										readonly type="text" name="giftMoney1" id="giftMoney1" />
								</div>

								<div class="ui-form-item">
									<label class="ui-label">流水倍数：</label> <input class="ui-ipt"
										type="text" name="waterTimes" id="waterTimes1"
										readonly="readonly" />
								</div>
							...
							<div class="prompt-info"
								style="padding-left: 150px; color: #727272; padding-bottom: 20px;">
					...
					<div id="j-record-form"
						class="tab-bd user-main zhangdan user-tab-box tab-panel">
						<ul id="j-records-action" class="ul-sidebar">
							<li class="active"><a href="#j-record-form"
								data-toggle="tab" data-href="/asp/depositRecords.aspx">在线存款</a>
							</li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/asp/transferRecords.aspx">户内转账</a></li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/asp/cashinRecords.aspx">手工存款</a></li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/asp/withdrawRecords.aspx">提款记录</a></li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/asp/consRecords.aspx">优惠活动</a></li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/asp/couponRecords.aspx">优惠券</a></li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/selfDetail_member.jsp">自助返水</a></li>
							<li><a href="#j-record-form" data-toggle="tab"
								data-href="/asp/depositOrderRecord.aspx">存款附言</a></li>
							<li onclick="redrecord()"><a href="#j-record-form"
								data-toggle="tab" data-val="girl">红包雨</a></li>
							<%--
					...
					<div id="user-vip" class="user-tab-box tab-panel active">
						<div class="ul_sidebar">
							<ul>
								...
								<li class="active"><a data-toggle="tab"
									href="#tab-personal">个人资料</a></li>
								<li><a data-toggle="tab" href="#tab-card-binding"
									class="check_name">银行卡绑定</a></li>
								<li><a data-toggle="tab" href="#tab-repass">修改密码</a></li>
								<!--<li>
						...
						<div id="tab-personal" class="user-tab-box tab-panel active">
							<div class="user_ziliao">
								<s:url action="change_info" namespace="/asp"
									var="modifyUserInfoUrl"></s:url>
								<form id="j-modify-form" action="${modifyUserInfoUrl}"
									method="post" class="ui-form">
									<table class="tb-form">
										<tr>
											<td>
												<div class="">
													<label class="ui-label">天威账户：</label> <span
														class="ipt-value">${session.customer.loginname}</span>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="">
													<label class="ui-label">注册货币：</label><span
														class="ipt-value">人民币</span>
												</div>
											</td>
										</tr>
										...
										<tr>
											<td>
												<div class="">
													<label class="ui-label">真实姓名：</label> <input class="ui-ipt"
														type="text" name="accountName" id="accountNameX"
										...
										<tr>
											<td>
												<div class="">
													<label class="ui-label">出生年月：</label> <input class="ui-ipt"
														type="text" name="birthday" id="birthday"
														onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
														My97Mark="false" readonly placeholder="请输入正确的生日日期"
														value="${session.birthday}" />
												</div>
											</td>
										</tr>
										<tr>
											<td>
												<div class="">
													<label class="ui-label">联络电话：</label><input class="ui-ipt"
														type="text"
										...
										<tr>
											<td>
												<div class="">
													<label class="ui-label">邮箱：</label> <input class="ui-ipt"
														type="text" name='email' data-rule-email="true"
														id='emailx'
										...
										<tr>
											<td>
												<div class="">
													<label class="ui-label">QQ：</label><input name="qq"
														class="ui-ipt" type="text"
														value='<s:property value="@dfh.utils.StringUtil@qqFormat(#session.customer.qq)" />'
														data-rule-digits="true" placeholder="请输入QQ" maxlength="20">
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="">
													<label class="ui-label">微信号：</label> <input
														name="microchannel" class="ui-ipt" type="text"
										...
										<tr>
											<td>
												<div>
													<input class="btn tijiao" type="submit" value="确认提交"
														id="J_sub_info">
												</div>
											</td>
										</tr>
                ...
                <label class="ui-label">邮寄地址：</label><input name="mailaddress" class="ui-ipt" type="text"  value="<s:property value="@dfh.utils.StringUtil@subStrBefore(#session.customer.mailaddress, 3)+'******'" />"  maxlength="50" placeholder="请输入邮寄地址">
						...
						<div id="tab-repass" class="user-tab-box tab-panel">
							<div class="update_pass">
								<h1 class="tab-tit">
									会员信息 ><span class="cee6"> 修改密码</span>
								</h1>
								...
								<form id="passwordform" class="ui-form" name="frmAction"
									...
									<div class="ui-form-item">
										<label class="ui-label">原密码：</label> <input type="password"
											class="ui-ipt" name="password" placeholder="请输入原密码"
											autocomplete="off" required />
									</div>

									<div class="ui-form-item">
										<label class="ui-label">新密码：</label> <input type="password"
											id="ipt_pwd" class="ui-ipt" autocomplete="off"
											name="new_password" placeholder="请输入新密码" maxlength="12"
											required data-rule-rangelength="8,12"
											data-rule-password1="true" />
									</div>

									<div class="ui-form-item">
										<label class="ui-label">确认密码：</label> <input type="password"
											class="ui-ipt" autocomplete="off" name="sPass2"
											maxlength="12" placeholder="请输入确认密码" required
											data-rule-equalto="#ipt_pwd" />
									</div>
						...
						<div id="tab-card-binding" class="user-tab-box tab-panel">
							<div class="yinhangka_box">
								<h1 class="tab-tit">
									会员信息 ><span class="cee6"> 银行卡绑定</span>
								</h1>
								<form id="blindCardForm" class="userform ui-form"
									action="${ctx}/asp/bandingBankno.aspx" method="post">
									<div class="ui-form-item" style="display: none">
										<label class="ui-label rq-value">银行/支付宝账户：</label> <select
											id="bdbank" class="ui-ipt" onchange="showyzmDiv(this.value)">
											<option value="">请选择</option>
											<s:iterator value="%{#application.IssuingBankEnum}" var="bk">
												<option value=<s:property value="#bk.issuingBankCode"/>>
													<s:property value="#bk.issuingBank" />
									...
									<div class="ui-form-item">
										<label class="ui-label rq-value" for="bankno">卡/折号：</label> <input
											type="text" name="bdbankno" id="bdbankno" class="ui-ipt"
											maxlength="100" autocomplete="off" />
									</div>
									<div class="ui-form-item c-red">
										<label class="ui-label" for="bankno">银行名称：</label> <input
											type="text" name="checkbankname" disabled id="checkbankname"
									...
									<div class="ui-form-item">
										...
										<%--防止自动填充--%>
										<input type="password" style="display: none;" /> <input
											type="password" class="ui-ipt" id="bdpassword" maxlength="15"
											name="bdpassword" autocomplete="off" />
									</div>
									<div class="ui-form-item" id="zfbyzmDiv" style="display: none;">
										<label class="ui-label" for="password_login">验证码：</label> <input
											type="text" class="ui-ipt" id="bindingCode" maxlength="6" />
										<span class="checkcode1"> <a href="javascript:void(0)"
											class="disFlag link" id="sendAlipayPhoneVoiceCodeBtn">语音验证</a>
											<a href="javascript:void(0)" class="disFlag link"
											id="sendAlipayPhoneCodeBtn">短信验证</a>
										</span>
									</div>
									<div class="tijiao_box">
										<input class="btn" type="button" value="确认提交"
											id="J_sub_bindCard" onclick="return checkbandingform();" />
									</div>
								</form>
						...
						<div id="tab-sms" class="user-tab-box tab-panel">
							<h1 class="tab-tit">
								会员信息 ><span class="cee6"> 短信通知</span>
							</h1>
							...
							<form class="ui-form" method="post">
								<div class="ui-form-item">
									<label class="ui-label">修改密码通知：</label> 短信 <input
										type="checkbox" name="service" value="3"
										<%=service.indexOf("3") == -1 ? "" : "checked"%> />
								</div>

								<div class="ui-form-item">
									<label class="ui-label">提款申请通知：</label> 短信 <input
										type="checkbox" name="service" value="5"
										<%=service.indexOf("5") == -1 ? "" : "checked"%> />
								</div>

								<div class="ui-form-item">
									<label class="ui-label">存款执行通知：</label> 短信 <input
										type="checkbox" name="service" value="9"
										<%=service.indexOf("9") == -1 ? "" : "checked"%> />
								</div>
								<div class="ui-form-item">
									<label class="ui-label">自助晋级礼金通知：</label> 短信 <input
										type="checkbox" name="service" value="2"
										<%=service.indexOf("2") == -1 ? "" : "checked"%> />
								</div>
								<%--
                            <div class="ui-form-item">
                            ...
                            --%>
								...
								<div class="ui-form-item">
									<input type="button" class="btn btn-pay" value="提交"
										onclick="return smsServie();" />
								</div>
					...
					<div id="tab-massages" class="user-tab-box tab-panel">
						<div class="ul_sidebar">
							<ul>
								<li class="active"><a href="#tab-one" data-toggle="tab"
									aria-expanded="true">收件箱</a></li>
								<li><a href="#tab-two" data-toggle="tab"
									aria-expanded="true">发件箱</a></li>
							</ul>
						</div>
						...
						<div id="tab-two" class="tab-panel letter-b">
							<div class="user-tab-box ui-form" style="margin: 0">
								<div class="ui-form-item">
									<label class="ui-label">标题：</label> <input type="text"
										name="guestbook.title" id="letter-title" autocomplete="off"
										class="ui-ipt" style="width: 400px;">
								</div>
								<div class="ui-form-item">
									<label class="ui-label">内容：</label>
									<textarea name="guestbook.content" id="letter-content"
										class="ui-ipt" style="width: 400px; height: 200px;"></textarea>
								</div>
								<div class="massage_tijiao">
									<input type="button" class="btn" id="btn-submit"
										onclick="saveLetter();" value="确认发送">
								</div>
							</div>
						</div>
					</div>
					<div id="tab-suggestion" class="user-tab-box tab-panel">
						<ul class="user-nav tab-nav">
							<li class="active" style="margin-left: 36px;"><a
								href="javascript:;" data-toggle="tab"><i
									class="iconfont icon-email"></i>问题返馈</a></li>
						...
						<div class="user-main tab-bd">
							...
							<div id="tab-gongdan">
								<div class="user-tab-box ui-form">
									<h1 class="suggestion-title">
										提交问题<span class="suggestionclose-btn"
											onclick="colseSuggestionForm()">&times;</span>
									</h1>
									<div class="ui-form-item">
										<label class="ui-label">您的问题：</label> <select
											id="suggestion-type" name="suggestion-type" title="问题"
											class="ui-ipt">
									...
									<div class="ui-form-item">
										...
										<textarea id="suggestion-content" name="suggestion-content"
											class="ui-ipt" rich="0" style="width: 400px; height: 200px"
											title="描述"></textarea>

									</div>
									<div class="ui-form-item">
										<button class="btn btn-danger" id="btn-submit"
											onclick="saveSuggestion();">创建</button>
									</div>
								</div>
							</div>
					...
					<div id="tab-service" class="user-tab-box tab-panel">
						<div class="ul_sidebar">
							<ul>
								<li class="active"><a href="#tab-service-column"
									data-toggle="tab" aria-expanded="true">专属客服</a></li>
							</ul>
						</div>
...
--%>
	...
	<!--支付宝弹窗{-->
	<div class="modal fade" id="j-modal-zfb" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-bd">
					...
					<div class="ui-form-item">
						<label class="ui-label rq-value" for="bankno">支付宝帐号：</label> <input
							id="j-zfb-account" type="text" class="ui-ipt" maxlength="30"
							autocomplete="off">
					</div>
					<div class="ui-form-item">
						<label class="ui-label rq-value" for="bankno">游戏密码：</label> <input
							type="password" style="display: none;"> <input
							id="j-zfb-password" type="password" class="ui-ipt" maxlength="30"
							autocomplete="off">
					</div>
					<div class="ui-form-item">
						<input class="btn btn-danger" type="button" value="提交"
							onclick="saveAlipayAccount()">
					</div>
					<div class="prompt-info">
						<h3 class="tit">温馨提示:</h3>
	...
	<!--救援金弹窗-->
	<div class="modal fade" id="j-modal-rescue" tabindex="-1" role="dialog"
		aria-labelledby="myModalLabel" style="display: none;">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-hd">
				...
				<div class="modal-bd">
					<input type="hidden" class="j-hd-id" /><input type="hidden"
						class="j-hd-url" />
					<div class="ui-form">
						<div class="ui-form-item" style="padding-left: 50px;">
							<label for="" class="ui-label"
								style="width: 100%; text-align: center; margin-left: 0;">请选择您喜欢的老虎机平台,
								确定后我们不接受任何重新转至其他老虎机平台的申请</label> &nbsp;&nbsp;&nbsp;<input type="radio"
								name="targetRescuePlatform" value="pttiger" checked="checked">PT老虎机
							&nbsp;&nbsp;&nbsp;<input type="radio" name="targetRescuePlatform"
								value="slot">老虎机账户(SW,MG,DT,PNG,QT,NT)
							&nbsp;&nbsp;&nbsp;<input type="radio" name="targetRescuePlatform"
								value="ttg">TTG老虎机
						</div>
						<div class="ui-form-item">
							<input type="button" class="btn btn-danger j-btn-apply"
								value="确定">
						</div>
					</div>
				</div>
	...
	<!--绑定密保{-->
	<div class="modal fade in" id="modal-bind-answer" tabindex="-1"
		role="dialog" data-modal-load aria-labelledby="myModalLabel">
			...
			<div class="modal-content">
				...
				<div class="modal-bd">
					<form method="post" class="ui-form" style="padding: 0">
						<div class="ui-form-item">
							<label class="ui-label">天威账户：</label> <span class="ipt-value">${session.customer.loginname}</span>
						</div>
						<div class="ui-form-item">
						...
						<div class="ui-form-item">
							...
							<s:select id="mar_questionid_mb2" name="questionid"
								list="%{#application.QuestionEnum}" cssClass="ui-ipt"
								listKey="code" listValue="text"></s:select>
						</div>
						<div class="ui-form-item">
							<label class="ui-label rq-value">您的回答：</label><input
								class="ui-ipt" style="margin-left: 4px;" type="text"
								id="mar_answer2" name="answer" required>
						</div>
						<div class="ui-form-item">
							<label class="ui-label rq-value">登录密码：</label><input
								class="ui-ipt" style="margin-left: 4px;" type="password"
								id="mar_pwd" name="answer" required>
						</div>
						<div class="ui-form-item">
							<input class="btn btn-danger" type="button" value="提交"
								onclick="commitBindingQuestion()">
						</div>
					</form>
				</div>
			</div>
	...
	<!--收件箱详情{-->
	<div class="modal fade" id="modal-letter" role="dialog"
	...
	<div class="mull">
		<div class="mas_show">
			<div class="title_mag">请先完善个人信息</div>
			<div class="msg_btn">
				<ul>
   ...
   class="user_icon z_index6"></i><span>确认</span></a></li>-->
					<li id="sdasd" style="width: 100%;">确认</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<script>
		$(document)
				.ready(
						function() {
							$(
									".qiandao_class a,.cunkuang a,.zhuanzhangle a,.tikuang a,#zzyouhui")
									.click(
											function() {
							...
							clip
									.on(
											...
											function(e) {
												var target = $(e.target);
												var val = $
														.trim(e.data['text/plain']);
												if (!val) {
													if (target
															.siblings('.remark-value').length) {
														alert('请先获取附言');
													}
													return;
												}
							...
							$('.deposit-code').attr(
									'src',
									'/asp/depositValidateCode.aspx?r='
											+ Math.random());
							/* 获取银行卡号和开户银行
							 * =====*/
							...
							bankList.find('a').on(
									...
									function() {
										...
										// 刷新验证码
										$(target).find('.deposit-code').attr(
												'src',
												'${ctx}/asp/depositValidateCode.aspx?r='
														+ Math.random());
										if ($(target).length == 0) {
											// 隐藏不存在的target
											$('#j-bank-list').siblings(
													'.tab-bd').find(
													'.tab-panel.active')
													.removeClass('active')
										}
												...
												window.TouClick
														.Start({
															...
															onSuccess : function(
																...
																//将二次验证口令赋值到隐藏域
																this_form
																		.appendChild(hidden_input_key);
																var hidden_input_address = document
																		.createElement('input');
																...
																//将二次验证地址赋值到隐藏域
																this_form
																		.appendChild(hidden_input_address);

																openProgressBar();
																var check_address = $(
																		"input[name='check_address1']")
																		.eq(0)
																		.val();
																var check_key = $(
																		"input[name='check_key1']")
																		.eq(0)
																		.val();

																$
																		.post(
																				"${ctx}/asp/sendAlipayPhoneVoiceCode.aspx",
																				{
												...
												window.TouClick
														.Start({
															...
															onSuccess : function(
																...
																$
																		.post(
																				"${ctx}/asp/sendAlipayPhoneSmsCode.aspx",
																				{
																					"check_address" : check_address,
																					"check_key" : check_key
																				},
		...
		function saveAlipayAccount() {
			...
			var str = "", $account = $("#j-zfb-account"), $password = $("#j-zfb-password");
			if (!$account.val()) {
		...
		function getAlipayAccount() {
			var zfbMsg = $('.j-zfb-msg'), account = zfbMsg
					.find('.j-account-ret'), zfbAction = $('#j-zfb-action');
			$
					.post(
							"/asp/getAlipayAccount.aspx",
							function(data) {
								if (data === 'empty') {
									zfbMsg.data("ac", "0");
									zfbMsg
											.html("请先绑定您的支付宝存款账号：  "
													+ '<a href="javascript:;" class="btn btn-pay" data-toggle="modal" data-target="#j-modal-zfb">绑定</a>');
									...
									zfbMsg
											.html('您目前绑定的存款账号是：'
													+ str
													+ '&nbsp;&nbsp;<a href="javascript:;" class="btn btn-pay" data-toggle="modal" data-target="#j-modal-zfb">修改绑定</a>');
									zfbAction.off('click');
								}
							});
		}
					...
					"username" : username
						...
						function(respData) {
							if (respData.length == 5 || respData.length == 4) {
								...
								$(obj).siblings('.remark-value').html(respData)
										.siblings('.btn-copy')
										.attr('data-clipboard-text', respData);
							} else {
								alert(respData);
							}
							$('.deposit-code').attr(
		...
		function createValidatedPayOrder() {
			...
			if (b_validate) {
				$
						.post(
								"${ctx}/asp/createValidatedPayOrder.aspx",
								{
									amount : depositAmount
								},
								function(data) {
									if (data.code == '1') {
										$('#validateAmountDepositResult')
												.text(
														'我们能够为您处理的金额为：'
																+ data.amount
					...
					.ajax({
						...
						success : function(data) {
							if (data != null) {
								$("#validateAmountDepositBankInfo")
										.append(
												"<tr><th>账户名：</th><td><span style='color:red;'>"
														+ data.username
														+ "</td><th>开户行：</th><td><span style='color:red;'>"
														+ data.bankname
														+ "</span></td></tr>");
								$("#validateAmountDepositBankInfo")
										.append(
												"<tr><th>帐号：</th><td><span style='color:red;'>"
														+ data.accountno
														+ "</td><th>存款验证QQ：</th><td><span style='color:red;'>800134430</span></td></tr>");
								ret = true;
							} else {
								ret = false;
							}
					...
					.get(
							...
							function(data) {
								...
								for (var i = 0; i < data.length; i++) {
									...
									var nuber = bankno
											.substr(bankno.length - 4);
									var $html = "<li><div class='user_bank_massage'><a onclick='untied(\""
											+ nuber
											+ "\")' class='untied'>解绑</a><span>"
											+ data[i].bankname
											+ "</span><span>"
											+ data[i].bankno
		...
		function untied(data) {
			var _html = '<div class="untied-alert">'
					+ '<p class="warning">您是否确认解绑此银行卡(尾号'
					+ data
					+ ')?</p>'
		...
		function queryfriendMoney() {
			...
			$
					.post(
							"/asp/queryfriendBonue.aspx",
							function(returnedData, status) {
								if ("success" == status) {
									closeProgressBar();
									var strs = returnedData.split('#');
									$("#friendmoney").html(strs[0] + "元");
									var friendurl = document.domain
											+ "?friendcode=" + strs[1];
									$("#friendurl").html(friendurl).attr(
											'href', friendurl);
									$("#fCode").qrcode({
										width : 200,
										height : 200,
		...
		function getbank_money() {
			$.get('/asp/queryBankAll.aspx', function(data) {
				for (var i = 0; i < data.length; i++) {
					...
					var $html = $("<option value='" + data[i].bankname + "'>"
		...
		$(function() {
			...
			$("#zhifubaoq").click(
					function() {
						$(".zhifubao_type li").last().addClass("action")
		...
		var $recordsIframe = $('#j-record-form'), $recordsAction = $('#j-records-action'), $iframe = $recordsIframe
				.find('iframe'), $recordTitle = $recordsIframe
				.find('.tab-tit1');
		$(function() {
			// console.log('test');
		...
		$(function() {
			...
			if ($("#accountNameX").val() != '') {
				$("#accountNameX").attr("disabled", 'disabled').removeAttr(
						'data-rule-chinese-name')
			}
			if ($("#emailx").val() != '') {
				$("#emailx").attr("disabled", 'disabled').removeAttr(
						'data-rule-email')
			}
			...
			$('#j-modify-form').validate(
					{
						submitHandler : function(form) {
							$.post('${ctx}/asp/change_infoAjax.aspx', $(form)
			...
			$('#passwordform').validate(
					{
						submitHandler : function(form) {
							$.post('${ctx}/asp/change_pwsAjax.aspx', $(form)
									.serialize(), function(data) {
								alert(data);
								window.location.reload();
							});
		...
		$(function() {
			...
			$tabAboutUs.length
					&& $tabAboutUs.find(
							'a[href="' + window.location.hash + '"]').tab(
							'show');
			...
			$("#j-user-nav").find(".tikuang").click(
					function() {
						$("#tab_withdraw ul li").find('a[href="#qukuang"]')
								.tab('show');
					})
...
--%>
	<script type="text/javascript"
		src="${ctx}/js/allInOnePay.js?v=90000002"></script>
...
<script src="//js.touclick.com/js.touclick?b=68aca137-f3c5-457b-87a4-8a46880b1e66"></script>-->
	...
	<script>
										...
										$("#redRainIn")
												.html(
														'<option value="">请选择目标帐户</option>'
																...
																+ '<option value="bbin"> BBIN账户</option>'
																+ '<option value="sba"> 沙巴体育账户</option>'
																+ '<option value="mg"> MG账户</option>')
									}
								});
		...
		function redrecord() {
			//红包雨记录
			$.post("/redrain/queryRedRainCount.aspx", function(returnedData,
					status) {
				if ("success" == status) {
		...
		function pageContents(index) {
			...
			if (ceoList.length < 1) {
				$("#list-table1 tbody").html(
						"<tr><td colspan='5'>查无资料</td></tr>");
				return false;
			}
			...
			if (index != 1) {
				paginationHtml += '<a href="javascript:void(0);" onclick="pageContents('
						+ page_past + ');">上一页</a>&nbsp;&nbsp;';
			}
			if (index != page_max) {
				paginationHtml += '<a href="javascript:void(0);" onclick="pageContents('
		...
		var $friendsRecord = $('#record-hy'), $friendsRecordsAction = $('#friends-records-action'), $friendsIframe = $friendsRecord
				.find('iframe');
		$(function() {
	...
	<script>
		...
		function updateDatePayPassword() {
			var newPayPassWord = $("#newPayPassWord").val(), data = {};
			...
			openProgressBar();
			$.post("/asp/change_pwsPayAjax.aspx", data, function(returnedData,
					status) {
				if ("success" == status) {
					closeProgressBar();
					alert(returnedData);
		...
		$(function() {
			...
			var _state = false;
			var _isDraw = false;
			var _vip = [ '新会员', '忠实VIP', '星级VIP', '黄金VIP', '白金VIP', '钻石VIP',
					'至尊VIP' ]
			function queryBirthday() {
				...
				$.post("/asp/getBirthdayMoney.aspx", {}, function(result) {
					...
					$('#vip-grade,#vip-grade1,.vip-grade1').html(
							_vip[result.level])
												...
												function(result) {
													...
													layer
															.open({
																...
																,
																content : '<div class="alert"><table><tr><th>类别</th><th>金额</th><th>时间</th>'
																		+ _table
																		+ '</table></div>',
																btn : [ '我知道了' ]
															});
			...
			$('#tab-birthday #redCoupon-submit ,.birthday-btn-no')
					.on(
							'click',
							function() {
								if (_isDraw)
													...
													if (result.state) {
														layer
																.open({
																	...
																	anim : 5 //0-6的动画形式，-1不开启
																	,
																	content : '<div class="alert"><p class="b-moeny">'
																			+ result.message
																			+ '</p></div>',
																	btn : [ '我知道了' ]
																});
