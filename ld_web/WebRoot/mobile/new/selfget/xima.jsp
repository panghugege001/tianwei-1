...
<html>
	...
	<body>
		...
		<div class="text-tips">
			...
			<ol>
				<p>1.自助返水限定PT、MG、QT、PNG、NT、TTG、DT、SW老虎机。（PT老虎机带有奖池类的无法进行自助返水，隔天进行系统返水。）</p>
				<p>2.自助返水的最低金额为1元。（要是您没达到自助返水的最低金额是不能自助返水的）。</p>
				<p>3.每天的00：00—03：00和12：00—15：00为系统结算时间，暂不能申请自助反水。 每日反水结算时间为：AGIN、体育从昨天12点到今天12点，PT、MG、TTG、QT、NT、DT、SW、CQ9从昨天0点到今天0点。PNG从昨天8点到今天8点。所产生的有效投注额*该金额对应的比例，未自助反水将通过系统反水进行结算。</p>
				<p>4.自助返水无次数限制，自助返水申请提交后，会在5分钟内通过审核，返水金额会自动添加到您的天威账号中。</p>
				<p>5.若要领取SW，MG，DT，QT，NT，PNG自助反水，请点击老虎机类型进行自助反水。</p>
			</ol>
		</div>
