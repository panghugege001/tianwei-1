...
<head>
    ...
    <jsp:include page="/mobile/commons/header.jsp">
        <jsp:param name="Title" value="我要存款"/>
    </jsp:include>
    <link rel="stylesheet" type="text/css" href="/mobile/css/new/account.css"/>
    <style type="text/css">
    	.list-group.active .page{display: block;}
    	.page-top{ color: #fff; padding-top:0.8rem;}
    	.page-top {line-height: 0.8rem;}
    	.page-top .main-money{margin: 0 auto; border-radius: 0.4rem; text-align: center; width: 5.586666rem;background: #dfa85a; 
    		height: 0.8rem;line-height: 0.8rem;color: #fff;font-size: 15px;}
    </style>
</head>
<body>
<script type="text/javascript" src="/mobile/js/TPPManage.js"></script>
...
<div class="page-top">
	主账户余额
	<div class="main-money">${session.customer.credit}</div>
</div>	
<!--内容-->

<br />
<div class="list-group">
    <a class="list-item" id="deposit-fast" href="/mobile/new/deposit/fast.jsp">
        支付宝、微信、网银存款<span class="c-ylow">加赠0.5%</span><i class="iconfont fr icon-downjiantou"></i>
    </a>
    <div id="deposit-fast-page-1" class="page hidden">
        <!--极速转账-->
    ...
    <div id="btn-history" class="mui-btn mui-btn--raised mui-btn--primary small">查看历史银行记录</div>
        ...
        <div class="text-tips">
            ...
            <p>
                <span class="c-ylow">使用秒存转账赠0.5%，满300再赠免费红包。</span><br/>
    ...
    <div id="deposit-fast-page-2" class="page" style="display:none;">
        ...
        <div class="tab-content">
            <!--		<div class="space-2"></div>-->
            <div class="mui-col-xs32-10 mui-col-xs32-offset-1 mui-col-xs64-10">
                <font class=" _content">我们的收款账户</font>
                <div class="space-2"></div>
                <div class="testfueld">
            ...
            <div class="space-2"></div>
            <div class="mui-col-xs32-10 mui-col-xs32-offset-1 mui-col-xs64-10">
                <font class=" _content">您的存款信息</font>
                <div class="space-2"></div>
                <div class="testfueld">
    ...
    padding: 20px;">
            <p class="  ">您需要存入金额：</p>
            <p class="  " id="real-save-money"></p>
            <div class="space-2"></div>
            <div class="gray-tips  ">温馨提示：请您存入该金额，否则存款无法到账，本订单有效时间为2小时</div>
            <div class="space-2"></div>
            <div class="tips"><input type="checkbox" id="must-checked">我已明白需要转账 <span
                    class="save-money "></span>元
            </div>
            <div class="tips"><input type="checkbox" id="must-checked1">本人已同意，如未转账 <span
                    class="save-money "></span>元，导致系统无法匹配存款，天威概不负责！
            </div>
            <div class="space-2"></div>
...
<div class="list-group">
    <div class="list-item" id="deposit-cloud">
    	云闪付<span class="c-ylow">加赠0.5%</span>
            <i class="iconfont fr icon-downjiantou"></i>
    </div>
    <div id="deposit-cloud-page-1" class="page hidden">
        <!--极速转账-->
        <div class="tab-content">
            <!--		<div class="space-2"></div>-->
            <div class="mui-col-xs32-10 mui-col-xs32-offset-1 mui-col-xs64-10">
                ...
                <div class="text-center">
                    <div style="margin-bottom:5px;"><font color="">云闪付APP下载二维码</font></div>
        ...
        <div class="text-tips">
            <div class="h3"><strong>温馨提示：</strong></div>
            <p>
                <span class="c-ylow">1.云闪付请下载云闪付APP才能进行存款支付。</span><br/>
                2.云闪付存款需要填写正确支付银行卡号末四码系统才会正确匹配到帐。<br/>
                3.支付金额需要与填写存款金额一样系统才会匹配上分。<br/>
                <span class="dark" class="c-ylow">4.使用云闪付秒存转账赠0.5%，满300再赠免费红包。</span>
            </p>
            <div class="space-2"></div>
        </div>
    </div>
    ...
    padding: 20px;">
            ...
            <div class="tips"><input type="checkbox" id="j-cloudpay-checked">
                <label for="j-cloudpay-checked">我已明白需要转账<span class="quota "></span>元</label>
            </div>
            <div class="tips"><input type="checkbox" id="j-cloudpay-checked1">
                <label for="j-cloudpay-checked1">本人已同意，如未转账<span
                        class="quota "></span>元，导致系统无法匹配存款，天威概不负责！</label>
            </div>
            <div class="space-2"></div>
            <div class="mui-btn mui-btn--raised mui-btn--primary block " id="j-cloud-agree">   下一步 </div>
        </div>
    </div>
...
<div class="list-group">
    <div class="list-item" id="deposit-gather">
    	通用支付,<span class="c-ylow" >微信、支付宝、QQ钱包</span><i class="iconfont fr icon-downjiantou"></i>
    </div>
    <div class="page hidden">
        <div class="tab-content" id="deposit-gather-content">
            ...
            <div >
                ...
                <div class="space-2"></div>
                <p><font color="">请扫描二维码</font></p>
                <img src="" style="width:100%;" id="j-gather-codeimg" style="width:100%;"/>
                <p><font color="">请扫码后在备注栏填写您的游戏账号：(例如:longdu) 可立即到账,账号写错或不写则无法到账!!!
...
<div class="list-group">
    <div class="list-item" id="deposit-weixin">微信支付<i class="iconfont fr icon-downjiantou"></i></div>
    <div class="page hidden">
...
<!--微信秒存
   <li>
       <div class="title" id="deposit-wechat">微信秒存<span style="color:;">加赠0.5%</span></div>

       <div id="deposit-weixinfast-page-1" class="page">
           <div class="tab-content">
               <div class="space-2"></div>
               <div class="mui-col-xs32-10 mui-col-xs32-offset-1 mui-col-xs64-10">

                   <font>微信秒存笔笔存 笔笔送<span class="c-">0.5%</span></font>
                   <div class="space-2"></div>
                   <div class="mui-select">
                       <label>微信秒存</label>
                       <div id="deposit-weixinfast-pay"></div>
                   </div>
                   <div class="testfueld">
                       <label>存款金额</label>
                       <input id="deposit-weixinfast-money" type="text" data-rule-digits="true" maxlength="10"
                              placeholder="存款金额额度为20元-5000元">

                   </div>
                   <div class="space-2"></div>
                   <div id="deposit-weixinfast-submit" class="mui-btn mui-btn--raised mui-btn--primary block">确定支付
                   </div>
               </div>
               <div class="space-2"></div>
           </div>
           <div >
               ...
               <p>单笔最低存款20元，最高存款5000；</p>
               <p><span style="color:;">请您按照官网提示的额度和留言进行存款否则无法快速到帐，如有疑问可以随时联系在线客服进行谘询。</span></p>

               <div class="space-2"></div>
           </div>
       </div>
       <div id="deposit-weixinfast-page-2" class="page j-deposit-weixinfast-page-2">
           <div class="tab-content black">
               <div class="space-2"></div>
               <div class="mui-col-xs32-10 mui-col-xs32-offset-1 mui-col-xs64-10">
                   <div class="space-2"></div>
                   <div class="center"><font color="">微信秒存</font></div>
                   <div class="space-2"></div>
                   <div class="testfueld">
                       <label>转账金额</label>
                       <input type="text" id="deposit-weixinfast-je" disabled="" readonly>
                   </div>
                   <div class="center">微信留言<font color="" >（留言务必填写付言否则无法到帐）</font></div>
                   <div class="space-2"></div>
                   <div id="fyan" class="testfueld">

                       <input id="deposit-weixinfast-fuyan" type="text" readonlystyle="color:;font-size:18px;">
                       <button class="btn-copy mui-btn mui-btn--raised mui-btn--primary" style="width:30%" onclick='copyToClipboard(document.getElementById("deposit-weixinfast-fuyan"))'>复制
                       </button>
                   </div>


                   <div id="deposit-weixinfast-qycode" style=" margin:0 1rem;">
                       <label>微信二维码<span
                               style="color:;margin-left:6px;font-size:12px;">微信二维码3分钟未到账联系24小时客服</span><br/>请长按二维码保存到手机！每次二维码只能存款一次！</label>
                       <img src="" style="width:100%; height:32%;" class="j-codeimg"/>
                   </div>

                   <div class="space-2"></div>
                   <div id="deposit-weixinfast-submit" onClick="destroyPayOrder();"
                        class="mui-btn mui-btn--raised mui-btn--primary block">作废此订单
                   </div>
                   <div class="text-tips">
                       <div class="h3"><strong>温馨提示：</strong></div>
...
<div class="list-group">
    <div class="list-item" id="deposit-zfbQR2">
    	
    </span>支付宝在线支付<i class="iconfont fr icon-downjiantou"></i>
    </div>
    <div class="page hidden">
        <!--支付宝在线-->
        <div class="tab-content">
            ...
            <div >
                <div class="h3"><strong>温馨提示：</strong></div>
                <p>
                    1.【支付宝支付】最低存款金额<span class="c-">10元</span>，单笔最高<span class="c-">3000元</span>。
                </p>
                <p>
                    2.【支付宝支付】第三方需收取<span class="c-">0.9%-2.5%</span>手续费。
                </p>
                <div class="space-2"></div>
            </div>
        </div>
...
<!-- <li>
        <div class="title icon_zhifubao" id="deposit-fast">支付宝扫码</div>

        <div class="page" >
            <div class="tab-content" id="deposit-zfbQR1-content">
                <div class="space-2"></div>
                <div >
                    <div class="h3 bold">二维码支付</div>
                    <div class="space-3"></div>
                    <div class="testfueld">
                            <input id="deposit-zfbQR1-account" type="text" value="未绑定" disabled="" readonly>
                        <label>支付宝帐户</label>
                        <div id="deposit-zfbQR1-bind" class="mui-btn mui-btn--raised mui-btn--pink small" >绑定</div>
                      </div>
                      <div id="deposit-zfbQR1-image" style="text-align:center;"></div>
                </div>
                <div >
                    <div class="h3 bold">温馨提示：</div>
                    <ol>
                        <li><font color="">支付宝最低存款1元。</font></li>
                        <li>使用支付宝<font color="">“二维码”扫描存款</font>，需要先绑定您的支付宝账号。</li>
                        <li>支付宝<font color="">“二维码”扫描存款</font>，必须用您绑定的支付宝账号进行存款，否则无法实时到账。</li>
                        <li>每位会员只能绑定一个支付宝帐号。</li>
                        <li>支付宝04：00——05：00为系统维护时间，所以在此时间段进行支付宝存款，存款将会延迟到账。</li>
                    </ol>
                    <div class="space-3"></div>
                </div>
            </div>
...
<!--<li>
        <div class="title flaticon-right133" id="deposit-zfbRemark">支付宝附言</div>
        <div class="page" >
            ...
            <div class="tab-content">
                ...
                <div >
                    <div class="testfueld">
                        <input id="deposit-zfbRemark-loginName" type="text" disabled="" readonly>
                        <label>账户信息</label>
                    </div>
                    <div class="testfueld">
                        <input id="deposit-zfbRemark-accountNo" type="text" disabled="" readonly>
                        <label>支付宝账号</label>
                    </div>
                    <div class="testfueld">
                        <input id="deposit-zfbRemark-remark" type="text" class="remark" readonly >
                        <label>附言</label>
                    </div>
                    <div id="deposit-zfbRemark-submit" class="mui-btn mui-btn--raised mui-btn--pink block" >跳转支付宝</div>
                    <div class="space-2"></div>
                </div>
                <div >
                    ...
                    <div class="h3"><strong>温馨提示：</strong></div>
                    <ol>
                        <li>存款账号随时都会变更，请您每次存款时查看公司的最新账号。</li>
                        <li>请您在支付宝页面存款<font color="">“付款说明”</font>处填写您的<font color="">“附言”</font>，否则无法实时到账。</li>
                    </ol>
...
<div class="list-group">
    <div class="list-item" id="deposit-QQ">QQ支付<i class="iconfont fr icon-downjiantou"></i></div>
    <div class="page hidden">
        <div class="tab-content" id="deposit-QQ-content">
            ...
            <div >
                <div class="h3"><strong>温馨提示：</strong></div>
                <p>
                    1.QQ支付存款最低<span class="c-">2元</span>。
                </p>
                <p>
                    2.【微信扫一扫】需要承担<span class="c-">1.2%-1.5%</span>手续费，收费标准根据第三方支付通道为主，手续费由第三方收取
                </p>
                <div class="space-2"></div>
            </div>
        </div>
...
<div class="list-group">
    <div class="list-item" id="deposit-jd">京东支付<i class="iconfont fr icon-downjiantou"></i></div>
    <div class="page hidden">
        <div class="tab-content" id="deposit-jd-content">
            ...
            <div >
                <div class="h3"><strong>温馨提示：</strong></div>
                <p>
                    1.京东支付存款最低<span class="c-">2元</span>。
                </p>
                <p>
                    2.京东支付需要承担<span class="c-">1.2%-1.5%</span>手续费，收费标准根据第三方支付通道为主，手续费由第三方收取
                </p>
                <div class="space-2"></div>
            </div>
        </div>
...
<!--<li>
        <button class="title icon_weixin" id="deposit-weixin">微信转帐无限额</button>
        <div class="page" >

            <div >
                    <div class="center"><strong class="">请在留言处填写正确的游戏账号</strong></div>
                    <div class="center" style="margin:.5rem 0"><img src="${ctx}/images/user/wxxe.png" width="210" height="210" /></div>
                    <div class="h3"><strong>温馨提示：</strong></div>
                    <p>
                         1.<strong class="">【请认定指定收款微信二维码】付款后以留言处的游戏账号为准进行处理</strong>。<br />
                         2.如需要存款，请直接转帐给该微信，并且在留言处备注您的游戏帐号。<br />
                         3.该微信号只仅用于存款，如您需要谘询游戏事宜及其他优惠，请联系我们在线客服。
                    </p>
                    <div class="space-2"></div>
                </div>
        </div>
...
<!--<li>
        <div class="title flaticon-right133" id="deposit-WXValidate" >微信存款额度验证</div>
        <div class="page" >
            <div class="tab-content">
                <div class="space-2"></div>
                ...
                <div class="mui-col-xs32-10 mui-col-xs32-offset-1  mui-col-xs64-5" id="deposit_WXValidate_pay_content">
                    <div class="space-3"></div>
                    <div class="testfueld" id="WXValidate-input-area">
                        <input id="deposit-WXValidate-amount" onkeypress="return mykeypress(this, event);" maxlength="7" type="text" >
                        <label>存款金额</label>
                        <div class="message">提示：只能输入两位小数</div>
                    </div>
                    <div class="mui-btn mui-btn--raised mui-btn--primary block" id="deposit-WXValidate-submit">提交</div>
                    <div class="mui-btn mui-btn--raised mui-btn--primary block" id="deposit-WXValidate-discard" style="display:none">废除订单</div>
                    <div id="depositResult"></div>
                    <div id="deposit-WXValidate-payInfo" style="text-align:center;margin:10px;"></div>
                </div>
                <div class="space-2"></div>
                <div class="mui-col-xs32-10 mui-col-xs32-offset-1  mui-col-xs64-6 ">
                    <div class="h3"><strong>温馨提示：</strong></div>
                    <ol>
                        <li><font color="">此通道不收手续费。</font></li>
                        ...
                        <li><font color="">图表存款说明</font><img style="width:100%;" src="/mobile/images/wxvalidate.png?v=1"></li>
                    </ol>
                    <div class="space-2"></div>
                </div>
...
<div class="list-group">
    <div class="list-item" id="deposit-speedPay">快捷存款<i class="iconfont fr icon-downjiantou"></i></div>
    <div class="page hidden">
        <!--快捷存款-->
        <div class="tab-content">
            <div class="space-2"></div>
...
<div class="list-group">
    <div class="list-item" id="deposit-thirdPay">在线支付<i class="iconfont fr icon-downjiantou"></i></div>
    <div class="page hidden">
        <!--第三方-->
        <div class="tab-content" id="deposit-thirdPay-content">
            ...
            <div >
                ...
                <div class="mui-select">
                    <select  id="m-deposit-thirdPay-bank">
                        <option value="">请选择</option>
                    </select>
                    <label>银行种类</label>
                </div>
            ...
            <div class="h3 bold">温馨提示：</div>
            <p>
                最低存款额度为<strong class="" id="j-onlineMin">2</strong>元，最高<strong class=""
...
<!--<li>
        <div class="title flaticon-right133" id="deposit-fast">网银转帐</div>
        <div class="page" >

            <div class="tab-content" id="deposit-fast-content">
                <div class="space-2"></div>
                <div class="mui-col-xs32-10 mui-col-xs32-offset-1 mui-col-xs64-10">
                    <div class="mui-select ">
                        <div id="deposit-fast-bank"></div>
                        <label>银行种类</label>
                    </div>
                    <div class="deposit-bankInfo"></div>
                </div>
            </div>
        </div>
    </li>-->
<div class="list-group">
    <div class="list-item" id="deposit-card">点卡支付<i class="iconfont fr icon-downjiantou"></i></div>
    <div class="page hidden">
        <div class="tab-content">
            <div class="space-2"></div>
            <div id="deposit-card-form" style="text-align:center;color:;"></div>

            <div class="text-tips">
   
                <div class="h3"><strong>温馨提示：</strong></div>
                <p>
                    存款最低金额为<span style="color:;">1</span>元，点卡充值会扣取相应的手续费用。<br/>
                    存款过程中有任何疑问请联系我们的在线客服或者QQ客服、智付客服QQ：4008822311。<br/>
                    <span style="color:;">建议您使用网银转账，因为使用一卡通，充值卡，游戏点卡充值到账的金额与您实际存款的金额是有一个额度差的。到账金额比实际存款金额少。到账比例，请查看费率表。</span><br/>
                </p>
                <div class="space-2"></div>
                <table>
                    <tbody id="cardTable">
...
<script type="text/javascript">
    ...
    function DepositPage() {
        ...
        var _$titles = $('.list-group .list-item');
        ...
        function _titleClickEvent() {
            ...
            if (_$titles.parent().hasClass('active')) {
                ...
                //关闭其他打开的
                _$view.find('.list-group .list-item').removeClass('active');
            ...
            _fast.$btnFast.click(function (e) {
                ...
                if (msg != "") {
                    ...
                    if (_nextFlag == false) {
                        ...
                        if (saveType == 4) {
//                           $.post("/data/deposit/getWxZzQuota.json", function (response) {
                            $.post("/asp/getWxZzQuota.aspx", {'amount': saveMoney}, function (response) {
                                var amount = response;
                                if (amount > 0) {
...
//                                    url: "/data/deposit/newDeposit1.json",
                            dataType: "json",
                            data: formData,
                                ...
                                if (!massage) {
                                    ...
                                    if (response['force'] === true) {// 有订单
                                        ...
                                        if (ret) {
                                            formData['force'] = true;
                                            mobileManage.getLoader().open('处理中');
//                                                    $.post('/data/deposit/newDeposit1.json', formData, function (response) {
                ...
                if (result.success) {
                    if (result.data.bind) {
                        ...
                        if (result.data.auth) {
                            ...
                            that.image.append('<div style="color:;text-align:left;padding:5px;">' + result.message + '</div>');
                        }
            ...
            function _init() {
                ...
                _dCard.cardCode = new MobileComboBox({
                    ...
                    onChange: function (e) {
                        ...
                        var arr = _cardCit[_dCard.cardCode.getValue()];
                        var brr = arr.split(",");
                ...
                _dCard.cardCit = new MobileComboBox({
...
//                    _queryCardCit(jsonData);
             ...
             * 查询点卡面额
             */
            function _queryCardCit(jsonData) {
                var html = "";
                ...
                $.each(jsonData.data, function (index, vo) {
                    _cardCit[vo.dictName] = vo.dictShow;
            ...
            function _dCardPay() {
                var formData = {
                    ...
                    orderAmount: _dCard.cardCit.getValue(),
                    usetype: 1,
                    loginName: '${session.customer.loginname}',
...
//	}
        ...
        function _WeixinManage() {
            ...
            function _doPay() {
                ...
                if (_weixin.weixinPay.getValue().indexOf('zfwx') != -1) {
                    ...
                    mobileManage.getTPPManage().formSubmit('asp/ZfWxirect.aspx', formData);
                    ...
                    mobileManage.getTPPManage().formSubmit('asp/XftZfbirect.aspx', formData);
                    return;
        ...
        function _DCardManage() {
             ...
             * 查询点卡面额
             */
            function _queryCardCit(callback) {
                mobileManage.ajax({
                    url: 'mobile/json/card.json',
                    callback: function (result) {
                        if (result.success) {
                            _cardCit = result.data;
                        } else {
                            alert(result.message);
                        }
                        callback();
...
//        }
        ...
        function _WXValidateManage() {
            ...
            mobileManage.getBankManage().getWXValidatePayInfo(function (result) {
                if (result.success) {
                    if (result.data.wxBank.zfbImgCode) {
                        ...
                        payInfoHtml = '<span style="font-size:20px;">微信账号：<font color="">' + result.data.wxBank.accountno + '<></span>';
                    }
                    ...
                    that.errorMsg.html('<span style="font-size:20px;"><font color="">' + result.message + '<></span>');
            ...
            function existOrderContent(wxValidaTeAmout, payInfoHtml) {
                ...
                var str = '<span style="font-size:20px;">请您存入&nbsp;&nbsp;<span style="font-size:28px; color:">' + wxValidaTeAmout + '&nbsp;元</span>，否则无法到账!</span>'
                $('#depositResult').html(str);
                that.payInfo.append(payInfoHtml + '<div><b><font color="">如果您已支付 请等待系统处理此笔订单,如果您未支付,请进行支付，如有疑问可以随时联系在线客服进行谘询。<font><b></div>');
                that.amountArea.remove();
                that.button.remove();
            }
...
//	if($(this).find(".title").parent().hasClass("active")){
