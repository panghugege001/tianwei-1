			...
			<div class="slot-item-list item-game  active">
				<div class="filter_dropdown_content_sec">
					...
					<ul class="filter_item_content" id="filterUl">
						...
						<li class="filter_item">
							<a data-tab="CQ9" data-value='{"category":"CQ9"}' href="javascript:;">CQ9</a>
						</li>
						<li class="filter_item">
							<a data-tab="PG" data-value='{"category":"PG"}' href="javascript:;">PG</a>
						</li>
						<li class="filter_item">
						...
						<li class="filter_item">
							<a data-tab="BBIN" data-value='{"category":"BBIN"}' href="javascript:;">BBIN</a>
						</li>
...
<!-- 			<div class="slot_game_item game-info">
		...
		<div class="slot_game_item_list">
            ...
            <div class="live-item" id="pbgame"><img src="/mobile/img/sports_2.png" alt="" /></div>
		</div>
		<div class="slot_game_item_list">
			<div class="live-item" id="lotteryGame"><img src="/mobile/img/vrlottery.png" alt="" /></div>
		</div>
		<div class="slot_game_item_list">
			<ul class="content-filter filter_item_content" id="filter-3" style="padding-left: 0px;">
				<li class="filter_item active">
					<a data-tab="761QP" data-value='{"category":"761QP"}' href="javascript:;">761棋牌</a>
				</li>
				<li class="filter_item">
					<a data-tab="KYQP" data-value='{"category":"KYQP"}' href="javascript:;">开元棋牌</a>
				</li>
			</ul> 
			<div id="QPlist">
			</div>
		...
		<div class="slot_game_item_list">
			<div class="live-item" id="fanya" onclick="loginFyGame()"><img src="/mobile/img/fanya.png" alt="" /></div>
		</div>
...
<script type="text/javascript">
	...
	function bbinlivegame() {
		if('${session.customer==null}' == 'true') {
			...
			setTimeout(
				"window.location.href='/game/bbinLogin.aspx?gameKind=live'", 1000)
		}
	}	
	//n2
	function n2livegame() {
	...
	function loginPINGBOGame() {
		...
		setTimeout("window.location.href='/game/PBUserLogin.aspx'", 1000)
	}
...
<script>
	...
	$(function(){
		...
		var chessGameJson = {
			'761QP':[
				{'name':"761炸金花",'link':'/game/cg761Login.aspx?gameCode=zjh','imgUrl':'zjh.png'},
				{'name':"761龙虎",'link':'/game/cg761Login.aspx?gameCode=doratora','imgUrl':'lh.png'},
				{'name':"761抢庄牛牛",'link':'/game/cg761Login.aspx?gameCode=bull/mrob','imgUrl':'qznn.png'},
				{'name':"761通比牛牛",'link':'/game/cg761Login.aspx?gameCode=bull/fair','imgUrl':'tbnn.png'},
				{'name':"761牛牛看牌抢庄",'link':'/game/cg761Login.aspx?gameCode=bull/rob','imgUrl':'nnkpqz.png'},
				{'name':"761奔驰宝马",'link':'/game/cg761Login.aspx?gameCode=carbrand','imgUrl':'bcbm.png'},
				{'name':"761牛牛",'link':'/game/cg761Login.aspx?gameCode=bull','imgUrl':'nn.png'},
				{'name':"761德州扑克",'link':'/game/cg761Login.aspx?gameCode=texas','imgUrl':'dzpk.png'},
				{'name':"761欢乐三十秒",'link':'/game/cg761Login.aspx?gameCode=baccarat','imgUrl':'hl30m.png'},
				{'name':"李逵捕鱼",'link':'/game/cg761Login.aspx?gameCode=fish','imgUrl':'lkpy.png'},
				{'name':"百人牛牛",'link':'/game/cg761Login.aspx?gameCode=hundredbull','imgUrl':'brnn.png'},
				{'name':"飞禽走兽",'link':'/game/cg761Login.aspx?gameCode=animal','imgUrl':'fqzs.png'},
			],
			'KYQP':[
				{'name':"KY抢庄牛牛",'link':'/game/kyqpLogin.aspx?gameCode=830','imgUrl':'qznn.png'},
				{'name':"KY炸金花",'link':'/game/kyqpLogin.aspx?gameCode=220','imgUrl':'zjh.png'},
				{'name':"KY急速炸金花",'link':'/game/kyqpLogin.aspx?gameCode=230','imgUrl':'jszjh.png'},
				{'name':"KY德州扑克",'link':'/game/kyqpLogin.aspx?gameCode=620','imgUrl':'dzpk.png'},
				{'name':"KY通比牛牛",'link':'/game/kyqpLogin.aspx?gameCode=870','imgUrl':'tbnn.png'},
				{'name':"KY二八杠",'link':'/game/kyqpLogin.aspx?gameCode=720','imgUrl':'ebg.png'},
				{'name':"KY抢庄牌九",'link':'/game/kyqpLogin.aspx?gameCode=730','imgUrl':'qzp9.png'},
				{'name':"KY三公",'link':'/game/kyqpLogin.aspx?gameCode=860','imgUrl':'sg.png'},
				{'name':"KY幸运五张",'link':'/game/kyqpLogin.aspx?gameCode=380','imgUrl':'xywz.png'},
				{'name':"KY十三水",'link':'/game/kyqpLogin.aspx?gameCode=630','imgUrl':'sss.png'},
				{'name':"KY斗地主",'link':'/game/kyqpLogin.aspx?gameCode=610','imgUrl':'ddz.png'},
				{'name':"KY押庄龙虎",'link':'/game/kyqpLogin.aspx?gameCode=900','imgUrl':'yzlh.png'},
				{'name':"KY欢乐红包",'link':'/game/kyqpLogin.aspx?gameCode=880','imgUrl':'hlhb.png'},
				{'name':"KY21 点",'link':'/game/kyqpLogin.aspx?gameCode=600','imgUrl':'21d.png'},
			]
		}
		$('#filter-3 li').on('click',function () {
			var $this = $(this),
				tabAttr = $(this).find('a').attr('data-tab');
			$this.addClass('active').siblings('.active').removeClass('active');
		...
		function qpList(obj,imgurl){
			...
			Object.keys(obj).forEach(function(key){
				_html +='<div class="slot_game_item game-info">'
						...
						+	'<div class="game_item_operations">'
						+		'<div class="game-text">'+obj[key].name+'</div>'
						+		'<div class="o-btn qipai-btn btn-play" data-url="'+obj[key].link+'" onclick="hook()" data-type="'+name+'" >立即游戏</div>'
						+	'</div>'
						+'</div>'
			})
			$('#QPlist').html(_html)
	...
	$(document).on('click','.qipai-btn',function(){
		var $this = $(this),
