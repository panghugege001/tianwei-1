...
(function(MUI){
	function Datepicker(mui){
    	...
    	var dateTemplate = [
           	...
           	'				<div class="d-content-yesrmonth-last iconfont icon-arrow-left"></div>', 
           	'				<div class="d-content-yesrmonth-next iconfont icon-arrow-right"></div>',
           	'			</div>',
            ...
            '    		  	<div class="mui-btn mui-btn--raised mui-btn--danger cancel">取消</div>',
           	'			</div>',
           	'		</div>',
