iapiConf = {"loginServer":"login.goldenphoenix88.com","casinoname":"redcoral88","clientSkin":"redcoral88","clientType":"casino","clientPlatform":"mobile","clientVersion":null,"systemId":"426","serviceType":"GamePlay","loginDomainRetryCount":"2","loginDomainRequestTimeout":"30","loginDomainRetryInterval":"1"};
...
//Safari cookie sync
function safariCookieSync()
{
	var isSafari = /Safari/.test(navigator.userAgent) && /Apple Computer/.test(navigator.vendor);
	var cookieEnabled = navigator.cookieEnabled ? true : false;
		
	if (!(iapiConf['safariSyncDisabled'] == 1) && !inIframe() && isSafari && cookieEnabled)
	{
