...
<html>
	...
	<body>
		 <div class="main-wrap">
			...
			<div class="content">
				<%--<div class="tab-block">
					<div class="tab-button active">CQ9游戏</div>
				</div>--%>
		...
		/*	//滑动时 隐藏header
			...
			function queryGames(){
				var gameTemplateHtml = [
					...
					'<img src="images/cq9games/{1}" style="height: 186px;overflow: hidden;">',
			    ...
			    mobileManage.ajax({
			    	url:'mobile/json/game/cq9Phone.json?v=2019',
...
//			正式遊戲
			...
			function play_fun(code){
			    ...
			    var gameUri = "https://mobile22.gameassists.co.uk/MobileWebServices_40/casino/game/launch/lehucom/"+ code +"/zh-cn?loginType=VanguardSessionToken&isPracticePlay=true&casinoId=2712&isRGI=true&authToken=&lobbyurl=" + window.location.host + "/mobile/cq9.jsp";
