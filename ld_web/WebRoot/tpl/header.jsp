...
<div id="header" class="gb-header">
	...
	<div class="header-top-wp">
		<div class="container w_1038">
			<div class="new_logo" style="position: absolute; left: -75px; top: 45px;"><a href="/index.jsp"><img src="../images/new_logo.png"></a></div>
			<div class="link-info fl" style="width: 100%">
				...
				<a href="/sitemap.jsp" target="_blank" class="item">备用网址</a>
				<span class="null">|</span>
				...
				<c:if test="${session.customer==null}">
					<ul class="fr link-info">
						<li class="f_flat">
							...
							<span><input type="text" id="j-name2" placeholder="账号"></span>
						</li>
						<li class="f_flat">
							<span id="header_password"></span>
							<span><input type="password" id="j-pwd2"   placeholder="密码" style="text-indent: 40px;"></span>
						</li>
                        <input type="hidden" name="code" id="code" maxlength="4" autocomplete="off" placeholder="验证码"/>
						<li class="item">
							<span class="span_btn">
						...
						<li class="item">
							...
							<a class="i-btn" href="/safeCenter.jsp">
								<img src="../images/user/yaoshi.png" />
								忘记密码
							</a>
						</span>
						</li>
				...
				<c:if test="${session.customer!=null && session.customer.role eq 'MONEY_CUSTOMER'}">
					<ul class="fr link-info">
						...
						<li class="item">
							<a class="i-btn two" class="check_name" href="/asp/payPage.aspx?tab_deposit">存款</a>
						</li>
						<li class="item">
				...
				<c:if test="${session.customer!=null && session.customer.role ne 'MONEY_CUSTOMER'}">
					...
					<ul class="fr link-info">
						...
						<li class="item">
							<a class="balance-info" href="javascript:;">帐户余额:<span class="c-strong">${session.slotAccount}</span><i class="iconfont icon-refresh"></i> </a>
						</li>
						<!--<li class="item" >
				...
				<ul id="j-headerNav" class="gb-nav">
					...
					<li class="liafter">
						<a href="/live.jsp" class="live_game">
							<label>真人彩票</label>
							<span class="en_text">LIVE&LOTTERY</span>
						<i></i>
						</a>
					</li>
					<li class="liafter">
						<a href="#" class="sport_box">
							<label>电竞体育</label>
							<span class="en_text">SPORTS</span>
							<i></i>
						</a>
                        <!-- <div class="sport_game_box">
							<div class="w_1060">
					...
					<li class="liafter">
						<a href="#" class="Fishing_box">
							<label>捕鱼棋牌</label>
							<span class="en_text">FISHING&CHESS</span>
							<i></i>
						</a>
					...
					<li class="liafter">
						<!--class="j-check" -->
						<a href="/promotion.jsp" class="promotion_box">
							<label>最新优惠</label>
					...
					<div class="sub-nav-box sub-nav">
				        <div class="wrapper">
				            ...
				            <ul>
				                ...
				                <li>
				                    <a href="/slotGame.jsp?showtype=MGS">
				                        <i class="bg-mg_icon"></i><span>MG</span>
				                    </a>
				                </li>
				                <li>
				                    <a href="/slotGame.jsp?showtype=XIN">
				                        <i class="bg-xin_icon"></i><span>XIN</span>
				                    </a>
				                </li>
				                
				                <li>
				                    <a href="/slotGame.jsp?showtype=DT">
				                        <i class="bg-dt_icon"></i><span>DT</span>
				                    </a>
				                </li>            
				                <li>
				               ...
				               <li>
				                    <a href="/slotGame.jsp?showtype=QT">
				                        <i class="bg-qt_icon"></i><span>QT</span>
				                    </a>
				                </li>
				                <li>
				            ...
				            <ul>
				                <li>
				                        ...
				                        <a href="javascript:;" onclick="alert('请先登录帐号！');">
				                            <i class="bg-ag_icon"></i><span>AG国际厅</span>
				                        </a>
				                ...
				                <li>
				                        ...
				                        <a href="javascript:;" onclick="alert('请先登录帐号！');">
				                            <i class="bg-ag_icon"></i><span>AGIN(试玩)</span>
				                        </a>
				                ...
				                <!-- <li>
				                        ...
				                        <a href="javascript:;" onclick="alert('请先登录帐号！');">
				                            <i class="bg-n2_icon"></i><span>N2-Live</span>
				                        </a>
				                    
				                </li>
				                <li>
				                    <a href="/game/bbinLogin.php?gametype=2" target="_blank" title="波音体育">
				                        <i class="bg-bbin_icon"></i><span>波音体育</span>
				                    </a>
				                </li> -->
				                <li>
				                    <a href="javascript:;" onclick="sportGame()" target="_blank" title="沙巴体育">
				                        <i class="bg-sb_icon"></i><span>沙巴体育</span>
				                    </a>
				                </li>                
				            </ul>
				            ...
				            <ul>
				            	<li>
				                        ...
				                        <a href="javascript:;" onclick="alert('请先登录帐号！');" title="捕鱼游戏">
				                            <i class="bg-ag_icon"></i><span>AG捕鱼王</span>
				                        </a>
				                ...
				                <li>
				                        ...
				                        <a href="javascript:;" onclick="alert('请先登录帐号！');" title="捕鱼游戏">
				                            <i class="bg-pt_icon"></i><span>深海捕鱼</span>
				                        </a>
				                    
				                </li>
								<li><c:if test="${session.customer!=null}">
										<a href="${ctx}/game/gameLoginPtSW.aspx?mode=real&gameCode=sw_fufish_intw"
											target="_blank"> <i class="bg-ptsw_icon"></i><span>SW捕鱼</span>
										</a>
									</c:if> <c:if test="${session.customer==null}">
										<a href="javascript:;" onclick="alert('请先登录帐号！');"
											title="捕鱼游戏"> <i class="bg-ptsw_icon"></i><span>SW捕鱼</span>
										</a>
									</c:if>
								</li>
				                ...
				                <li>
					                    ...
					                    <a href="javascript:;" onclick="alert('请先登录帐号！');">
					                        <i class="bg-716_icon"></i><span>李逵劈鱼</span>
					                    </a>
				                ...
				                <li>
					                    ...
					                    <a href="javascript:;" onclick="alert('请先登录帐号！');">
					                        <i class="bg-716_icon"></i><span>飞禽走兽</span>
					                    </a>
