...
public class PageHelper implements Interceptor {
	...
	public static Map<String,Object> getPageMap(Page page){
		...
		resultParams.put("dataList", page.getResult());
		resultParams.put("pageNum", page.getPageNum());
		resultParams.put("pages", page.getPages());
		resultParams.put("pageSize", page.getPageSize());
		resultParams.put("total", page.getTotal());
		resultParams.put("startRow", page.getStartRow());
		resultParams.put("endRow", page.getEndRow());
		return resultParams;
	}
}
