...
public class BusinessException2 extends Exception {
    ...
    public BusinessException2(String message, Object[] args) {
        this("system_error", message, args);
    }

    public BusinessException2(String code, String message) {
        this(500, code, message, (Object[])null);
    }

    public BusinessException2(String code, String message, Object[] args) {
        this(500, code, message, args);
    }

    public BusinessException2(int status, String code) {
        this(status, code, "网络连接超时", (Object[])null);
    }

    public BusinessException2(int status, String code, String message) {
        this(status, code, message, (Object[])null);
    }

    public BusinessException2(int status, String code, String message, Object[] args) {
        super(message);
        this.status = 500;
