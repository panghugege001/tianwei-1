 ...
 * 讯联宝微信和支付宝支付提交网关参数
 */
public class XlbPayVo implements Serializable {
    ...
    public XlbPayVo(String apiName, String apiVersion, String platformID, String merchNo, String orderNo, String tradeDate, String amt, String merchUrl, String merchParam, String tradeSummary, String overTime, String customerIP, String signMsg) {
    ...
    public void setWxZfbH5(String platformID, String merchNo, String orderId, String tradeDate, String amt, String merchUrl, String merchParam) {
        this.platformID = platformID;
        this.merchNo = merchNo;
        this.orderNo = orderId;
        this.tradeDate = tradeDate;
    ...
    public void setOnline(String platformID, String merchNo, String orderNo, String tradeDate, String amt, String merchUrl, String merchParam, String bankCode) {
        this.bankCode = bankCode;
        setWxZfb(platformID, merchNo, orderNo, tradeDate, amt, merchUrl, merchParam, null);
    }
