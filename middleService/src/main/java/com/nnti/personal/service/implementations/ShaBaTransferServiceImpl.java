...
@Service("shabaTransferService")
public class ShaBaTransferServiceImpl extends BaseService implements IPlatformTransferService {

//	private static Logger log = Logger.getLogger(ShaBaTransferServiceImpl.class);
	...
	public String transferIn(AccountTransferDTO dto) throws Exception {
		...
		Const st = constService.get("转账SBA");
		...
		transfer.setTarget(PlatformCode.Transfer.getCode(Constant.SBA));
		...
		creditLog.setType(CreditChangeType.TRANSFER_SBA_IN);
	...
	public String transferOut(AccountTransferDTO dto) throws Exception {
		...
		message = BalanceUtil.transferOutAccount(product, Constant.SBA, loginName,null, amount, transferId);
		...
		Transfer transfer = new Transfer();
		transfer.setId(Long.parseLong(transferId));
		transfer.setSource(PlatformCode.Transfer.getCode(Constant.SBA));
		...
		CreditLog creditLog = new CreditLog();
		creditLog.setLoginName(loginName);
		creditLog.setType(CreditChangeType.TRANSFER_SBA_OUT);
		creditLog.setCredit(credit);
