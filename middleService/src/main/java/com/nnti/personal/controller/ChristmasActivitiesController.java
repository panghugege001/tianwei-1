 ...
 * TODO
 * @author Caesar
 * 2017年12月11日下午5:41:50
 */
@RestController
@RequestMapping("/activities")
public class ChristmasActivitiesController extends BaseController{
	 ...
	 * @return DataTransferDTO    返回类型  
	 * @date  2017年12月11日下午5:47:09
	 */
	@RequestMapping(value = "/V1.0/applyActivities", method = { RequestMethod.POST })
	public DataTransferDTO applyActivities(@RequestParam(value = "requestData", defaultValue = "") String requestData, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (lockFlag) {
				...
				msg = accountTransferService.activities(dto);
