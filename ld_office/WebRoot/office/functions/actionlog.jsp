...
<s:form action="queryActionLog" namespace="/office" name="mainform" id="mainform" theme="simple">
<div id="excel_menu_left">
记录 --> 会员事件记录 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>

<div id="excel_menu">
    <s:if test="%{#request.authStatus ==1}">
        事件:<s:select name="type" list="%{#application.ActionLogType}" listKey="code" listValue="text" emptyOption="true"/>
    </s:if>
    <s:else>
        事件:<s:select name="type" list="%{#application.ActionLogType}" listKey="code" listValue="text" emptyOption="true" disabled="true"/>
    </s:else>
...
CpuID:<s:textfield name="deviceID"></s:textfield>
	  ...
	  <div id="right_04">
		  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#99c8d7">
            ...
            <tr>
              ...
              <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;"><s:property value="@dfh.model.enums.ActionLogType@getText(#fc.action)"/></td>
