...
操作 --> 转账优惠提案 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>

<div id="excel_menu">
<p align="left"><s:fielderror/></p>
<s:form action="addBankTransferConsProposal" onsubmit="submitonce(this);" namespace="/office" name="mainform" id="mainform" theme="simple">
<table align="left" >
<tr><td>用户类别:</td><td>
...
<tr><td>转账金额:</td><td><s:textfield name="firstCash" size="30"/></td></tr>
<tr><td>优惠额度:</td><td><s:textfield name="tryCredit" size="30"/></td></tr>
