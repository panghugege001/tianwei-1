...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #b6d9e4; font-size: 11px">
		...
		<div id="excel_menu">
			<s:form action="repairPayOrderZf" onsubmit="submitonce(this);"
				...
				<table align="left">
					...
					<tr>
						<td colspan="2">
							<font color="blue">以下填写内容，请保持与智付数据一致；备注可为空</font>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							...
							list="#{'zf':'智付(2030028802)','zf1':'智付1(2030000006)','zf2':'智付2(2030020118)','zf3':'智付3(2030020119)','cmzf1':'通用智付1(2000295699)','cmzf2':'通用智付2','zfdk1':'智付点卡1(2000295566)','zfwx':'智付微信','zfwx1':'智付微信1(2000299861)'}" key="key"
