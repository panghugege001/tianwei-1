...
function responseMethod(data){
	...
	frm.submit();
		...
		<s:form action="queryDepositOrder" namespace="/office" name="mainform"
								...
								<table width="1250px" border="0" align="center" cellpadding="0"
												...
												<tr>
													...
													<td width="110px" align="left">
														<s:select cssStyle="width:100px" name="type"
															list="#{'':'全部','01':'网银转账','2':'支付宝转账','22':'支付宝新版','4':'微信转账','3':'微信秒存'}" listKey="key" listValue="value" />
													</td>
									...
									<s:iterator var="fc" value="%{#request.page.pageContents}">
										...
										<tr>
											...
											<td bgcolor="${bgcolorValue }" align="center">
												<s:property value="@dfh.utils.NumericUtil@formatDouble(#fc.inputamount)" />
											</td>
											<td bgcolor="${bgcolorValue }" align="center">
												<s:property value="@dfh.utils.NumericUtil@formatDouble(#fc.amount)" />
											</td>
											<%-- <td bgcolor="${bgcolorValue }" align="center">
												<s:property value="#fc.ubankname" />
											</td> --%>
											<%-- <td bgcolor="${bgcolorValue }" align="center">
												<s:property value="#fc.ubankno" />
											</td> --%>
											<td bgcolor="${bgcolorValue }" align="center">
											...
											<td bgcolor="${bgcolorValue }" align="center">
												<s:if test="#fc.type==0">
								             	...
								             	<s:elseif test="#fc.type==2">
	              								...
	              								<s:elseif test="#fc.type==22">
								              		支付宝新版
	              								</s:elseif>
	              								<s:elseif test="#fc.type==3">
								              		微信秒存
	              								</s:elseif>
	              								<s:elseif test="#fc.type==4">
								              		微信转账
	              								</s:elseif>
											</td>
