...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #b6d9e4; font-size: 11px">
		...
		<div id="excel_menu">
			<s:form action="repairPayOrderZfb" onsubmit="submitonce(this);"
				...
				<table align="left">
					...
					<tr>
						<td colspan="2">
							<font color="blue">以下填写内容，请保持与支付宝数据一致；备注可为空</font>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<s:select cssStyle="width:150px" list="#{'zfb':'支付宝'}" key="key"
