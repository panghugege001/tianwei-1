...
function responseMethod(data){
	...
	<body>
		...
		<div id="excel_menu" style="position: absolute; top: 25px; left: 0px;">
			<s:form action="getHBrecord" namespace="/office"
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0" width="1450px">
								<tr align="left">
									...
									<td colspan="2">
										类别:
										<s:select cssStyle="width:150px" list="#{3:'玩家奖金余额','':'全部奖金记录',1:'获得奖金记录',2:'使用奖金记录'}" key="key"   value="%{type}"
								 name='type'></s:select>
									</td>
									<td rowspan="2">
						...
						<div id="right_04">
							<table width="1210px" border="0" cellpadding="0" cellspacing="1"
								...
								<tr bgcolor="#0084ff">
									...
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('money');" width="130px">
										金额(元)
									</td>
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
								...
								<s:iterator var="fc" value="%{#request.page.pageContents}">
									<tr >
										...
										<td align="center" width="60px">
										<s:if test="#fc.phone==1">提款</s:if>
											<s:elseif test="#fc.phone==0">存款</s:elseif>
											<s:if test="#fc.deposit==1">提款</s:if>
											<s:elseif test="#fc.deposit==0">存款</s:elseif>
										</td>
