...
function submitAction(btn,billno){
   btn.disabled=true;
   var action = "/office/getSubmitGameAction.do";
...
function submitCancelAction(btn,billno){
   btn.disabled=true;
   var action = "/office/submitGameCancelAction.do";
...
function responseMethod(data){
	...
	frm.submit();
		...
		<s:form action="queryGameOrder" namespace="/office" name="mainform"
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td width="80px" align="left">
														<s:select cssStyle="width:80px" name="payOrderFlag"
													...
													<td width="200px" align="left">
														<s:textfield name="billno" size="30" />
													</td>
													<td align="right" width="60px">
														会员帐号:
													</td>
												...
												<tr>
													...
													<td width="110px" align="left">
															<s:select cssStyle="width:150px" list="#{'':'','ea':'ea','ag':'ag','agin':'agin','bbin':'bbin','keno':'keno','sba':'sba','pt':'pt','sixlottery':'sixlottery','ebet':'ebet','ttg':'ttg','jc':'ssc','nt':'nt','qt':'qt','png':'png','mwg':'mwg','n2live':'n2live','ptsky':'ptsky','bbin':'bbin','pb':'pb体育','fanya':'fanya','bit':'bit游戏'}" key="key"
								value="value" name="billnotype"></s:select>
													</td>
													<td align="right" width="60px">
														玩家姓名:
													</td>
													<td width="110px" align="left">
														<s:textfield name="accountName" size="15" />
													</td>
												</tr>
									...
									<tr>
										...
										<td bgcolor="#e4f2ff" align="center" colspan="7"></td>
									</tr>
									<tr>
										<td bgcolor="#e4f2ff" align="right" colspan="6">
											总计:
