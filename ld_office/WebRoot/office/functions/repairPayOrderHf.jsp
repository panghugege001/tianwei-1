...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #b6d9e4; font-size: 11px">
		...
		<div id="excel_menu">
			<s:form action="repairPayOrderHf" onsubmit="submitonce(this);"
				...
				<table align="left">
					...
					<tr>
						<td colspan="2">
							<font color="blue">以下填写内容，请保持与汇付数据一致；备注可为空</font>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<s:select cssStyle="width:150px" list="#{'hf':'汇付','汇付1':'汇付1','汇付2':'汇付2','汇付3':'汇付3','汇付4':'汇付4','汇付5':'汇付5','汇付6':'汇付6','汇付7':'汇付7'}" key="key"
