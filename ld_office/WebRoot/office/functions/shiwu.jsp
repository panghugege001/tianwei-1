...
操作 --> 事务提案 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>
<div id="excel_menu">
<p align="left"><s:fielderror/><s:actionerror/></p>

<s:form action="addAttachment" namespace="/batchxima" method ="post" enctype="multipart/form-data" theme="simple">
<table>
