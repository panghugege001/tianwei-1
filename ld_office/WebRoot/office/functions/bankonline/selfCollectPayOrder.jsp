...
$(document).ready(function(){
	  $.post("/bankinfo/querySelfCollectInfo.do",{"type":9},function(data){
		  var json = eval(data);
...
<s:form action="queryCmbTransferSelf" namespace="/office" name="mainform" id="mainform" theme="simple">
<div id="excel_menu_left">
记录 --> 支付宝/微信收款存款记录<a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>
