...
$(document).ready(function(){
	  $.post("/bankinfo/queryQrcodeBankinfo.do",{"bankname":"银行二维码"},function(data){
		  var json = eval(data);
...
<s:form action="queryCmbTransferQrCodeline" namespace="/office" name="mainform" id="mainform" theme="simple">
