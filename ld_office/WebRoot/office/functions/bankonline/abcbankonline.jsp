...
$(document).ready(function(){
	  $.post("/bankinfo/queryAlipayCards.do",{"bankname":"农业银行"},function(data){
		  var json = eval(data);
...
function excute(transfeId){
	...
	window.open ('<%=basePath%>/office/functions/bankonline/excuteabctransfer.jsp?transfeId='+transfeId+"&r="+Math.random(),'','height=250, width=500,toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no,top='+(height-400)/2+',left='+(width-300)/2 ) ;
}
</script>
<s:form action="queryAbcBankonline" namespace="/office" name="mainform" id="mainform" theme="simple">
<div id="excel_menu_left">
记录 --> 农行网银转账记录 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>

<div id="excel_menu">
农业银行账户:<select name="acceptName" id="acceptName" ><option></option></select>
	  ...
	  <div id="right_04">
		  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#99c8d7">
            <tr>
              ...
              <td bgcolor="#0084ff" align="center"  style="font-size:13px;;color: #FFFFFF;font-weight: bold">交易行名</td>
              <td bgcolor="#0084ff" align="center"  style="font-size:13px;;color: #FFFFFF;font-weight: bold">交易方式</td>
              <td bgcolor="#0084ff" align="center"  style="font-size:13px;;color: #FFFFFF;font-weight: bold">交易渠道</td>
              <td bgcolor="#0084ff" align="center"  style="font-size:13px;;color: #FFFFFF;font-weight: bold">交易说明</td>
            ...
            <tr bgcolor="${bgcolor}">
              ...
              <td  align="center"  style="font-size:13px;"><s:property value="#fc.jyzy"/></td>
              <td  align="center"  style="font-size:13px;"><s:property value="#fc.jyhm"/></td>
               <td  align="center"  style="font-size:13px;"><s:property value="#fc.jyfs"/></td>
                <td  align="center"  style="font-size:13px;"><s:property value="#fc.jyqd"/></td>
                 <td  align="center"  style="font-size:13px;"><s:property value="#fc.jysm"/></td>
              <td  align="center"  style="font-size:13px;"><s:property value="#fc.acceptName"/></td>
              <td  align="center"  style="font-size:13px;"><s:property value="#fc.acceptCardnum"/></td>
            ...
            <s:if test="#session.operator.authority=='boss' || #session.operator.authority=='finance' || #session.operator.authority=='finance_manager'">  
  	 	    <tr>
              ...
              <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;" colspan="8"></td>
            </tr>
            </s:if>
            <tr>
