...
$(document).ready(function(){
	  $.post("/bankinfo/queryBankinfo.do",{"bankname":"云闪付"},function(data){
		  var json = eval(data);
...
<s:form action="queryCmbTransferline" namespace="/office" name="mainform" id="mainform" theme="simple">
<div id="excel_menu_left">
记录 --> 云闪付存款订单记录 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>
