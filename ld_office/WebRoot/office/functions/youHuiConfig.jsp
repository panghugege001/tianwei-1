...
function changeIsused(id , isused , btn){
	btn.disabled = true;
	if(confirm("确定？")){
		$.post("/office/modifyYouHuiConfig.do",{"id":id,"isused":isused},function(data){
			alert(data);
			$("#mainform").submit();
		});
	}
	...
	<body>
		...
		<div id="excel_menu" style="position: absolute; top: 25px; left: 0px;">
			<s:form action="getYouHuiConfigs" namespace="/office"
							...
							<table border="0" cellpadding="0" cellspacing="0" width="860px">
								...
								<tr align="left">
									<td>  
										优惠类型:
										<s:select cssStyle="width:115px"
											list="#{'':'','自助PT首存优惠':'自助PT首存优惠','自助PT次存优惠':'自助PT次存优惠','自助PT限时优惠':'自助PT限时优惠','自助PT8元优惠':'自助体验金','自助EA次存优惠':'自助EA次存优惠','自助BBIN存送优惠':'自助BBIN存送优惠','自助TTG首存优惠':'自助TTG首存优惠','自助TTG次存优惠':'自助TTG次存优惠','自助TTG限时优惠':'自助TTG限时优惠','自助NT首存优惠':'自助NT首存优惠','自助NT次存优惠':'自助NT次存优惠','自助NT限时优惠':'自助NT限时优惠','自助QT首存优惠':'自助QT首存优惠','自助QT次存优惠':'自助QT次存优惠','自助QT限时优惠':'自助QT限时优惠','自助MG首存优惠':'自助MG首存优惠','自助MG次存优惠':'自助MG次存优惠','自助MG限时优惠':'自助MG限时优惠','自助DT首存优惠':'自助DT首存优惠','自助DT次存优惠':'自助DT次存优惠','自助DT限时优惠':'自助DT限时优惠','自助APP下载彩金':'自助APP下载彩金'}"
											name="type" listKey="key" listValue="value"
											emptyOption="false"></s:select>
									</td>
									
									<td>
										<a href="/office/functions/addYouHuiConfig.jsp" target="_blank" style="color:red;font-size: 14px;">新增优惠配置</a>
									</td>
								</tr>
							</table>
						</td>
						...
						<div id="right_04">
							<table width="1110px" border="0" cellpadding="0" cellspacing="1"
								...
								<s:if test="#fc.isused==0"><tr ></s:if>
										...
										<a href="/office/getConfig.do?id=<s:property value='#fc.id' />" ><s:property value="#fc.title" /></a>
										</td>
										<td align="center" width="60px">
											<s:property value="#fc.aliasTitle" />
										</td>
										<td align="center" width="60px">
											<s:property value="#fc.percent" />
										</td>
										<td align="center" width="60px">
											<s:property value="#fc.betMultiples" />
										</td>
										<td align="center" width="90px">
											<s:property value="#fc.limitMoney" />
										</td>
