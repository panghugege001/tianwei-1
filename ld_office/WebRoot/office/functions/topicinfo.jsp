			...
			<div id="right">
				<div id="right_01">
					<div id="right_001">
						...
						<div id="right_04">
							<s:iterator value="%{#request.page.pageContents}" var="topicInfo">
...
<%-- 									<s:if test="#guestbook.referenceId==null"> --%>
										<tr>
											...
											<td>
												...
												<s:if test="#topicInfo[6]==@dfh.utils.Constants@FLAG_TRUE">
												 已审核
												</s:if>
												<s:else>
...
<%-- 									</s:if> --%>
									<tr>
										<td width="300px" style="text-align: right; height: 50px;" valign="top">
											...
											<s:date format="yyyy-MM-dd HH:mm:ss"
												name="#topicInfo[3]"></s:date>
											<br />
										</td>
										<td valign="top" style="word-break: break-all;">
											<s:property escape="false"
												value="@dfh.utils.StringUtil@transform(#topicInfo[1])" />
										</td>
									</tr>
								</table>
							</s:iterator>
							...
							<c:if test="${topicInfo.topicType eq 1}">
							<s:form action="leaveReplyTopic"
