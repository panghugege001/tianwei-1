...
.input {
	...
	<body>
		...
		<div id="a1"
			...
			<s:form action="saveLeaveWords" onsubmit="submitonce(this);" namespace="/office" name="form1" id="form1" theme="simple">
		...
		<div id="a2"
			...
			<s:form action="saveLeaveWords" onsubmit="submitonce(this);" namespace="/office" name="form2" id="form2" theme="simple">
		...
		<div id="a3"
			style="border: solid; border-width: 1px; position: absolute; display: none; height: 475px; top: 76px; left: 50px; width: 810px; background-color: #CCC">
			<s:form action="saveLeaveWords" onsubmit="submitonce(this);" namespace="/office" name="form3" id="form3" theme="simple">
		...
		<div id="a4"
			style="border: solid; border-width: 1px; position: absolute; display: none; height: 475px; top: 76px; left: 50px; width: 810px; background-color: #CCC">
			<s:form action="saveLeaveWords" onsubmit="submitonce(this);" namespace="/office" name="form4" id="form4" theme="simple">
