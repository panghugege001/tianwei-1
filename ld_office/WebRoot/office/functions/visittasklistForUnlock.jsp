...
function submitForNewAction(action,pno){
  ...
  <body style="background:#b6d9e4;font-size:11px">
     <br>
     <p>电话回访-->管理任务列表-->解锁任务明细&nbsp;&nbsp;<a href="/office/functions/managetask.jsp"> <font color="red">上一步</font></a></p>
    <p>当前任务：<font color="blue"><s:property value="taskName"/></font>&nbsp;&nbsp;</p>
     <s:form action="getVisitTaskForUnlockByCondition" namespace="/telvisit" method="post" id="mainform" theme="simple">
    ...
    <div align="center" style="width:100%">
    	<s:if test="pageList!=null">
    		<display:table name="pageList" id="fc" requestURI="/telvisit/nextpageForCount.do" style="width:1000px" decorator="dfh.displaytag.util.TelvisitFormat">
				<display:column title="序号" style="text-align:center">${fc_rowNum}</display:column>
		    	<display:column property="loginnameforunlock" title="会员账号" style="text-align:left"></display:column>
