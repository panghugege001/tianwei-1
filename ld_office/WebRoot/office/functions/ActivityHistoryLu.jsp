...
function responseMethod(data){
	...
	<body>
		...
		<div id="excel_menu" style="position: absolute; top: 25px; left: 0px;">
			<s:form action="getActivityHistoryLu" namespace="/office"
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0" width="1450px">
								<tr align="left">
									...
									<td colspan="2">
										类别:
										<s:select cssStyle="width:150px" list="#{'':'请选择','1':'竞猜胜利','0':'竞猜失败'}" key="key"   value="%{type}"
								 name='type'></s:select>
									</td>
						...
						<div id="right_04">
							<table width="1210px" border="0" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td bgcolor="#e4f2ff" align="center"  style="font-size:13px;" colspan="4"></td>
								</tr>
