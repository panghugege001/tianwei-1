...
span.pagelinks {
   ...
   <br>
     <p>电话回访-->使用任务列表-->任务列表明细-->回访明细&nbsp;&nbsp;<a href="${nextURL}"> <font color="red">上一步</font></a></p>
    <br/>
     <div align="center" style="width:100%">
     	<p>回访对象：<font color="blue"><s:property value="loginname"/></font></p>
    	<display:table name="pageList" id="fc" requestURI="/telvisit/getRemarks.do" style="width:1000px" decorator="dfh.displaytag.util.TelvisitRemarkFormat">
		    	...
		    	<display:column property="execstatus" title="访问结果"  style="text-align:center;width:100px"></display:column>
