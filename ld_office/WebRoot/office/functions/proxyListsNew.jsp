...
客户分析 --> 代理输赢分析<a href="javascript:history.back();"> <font color="red">上一步</font></a>
</div>


<s:form action="queryCustomerInfoAnalysis" onsubmit="return customerinfoAnalysis();" namespace="/office" name="mainform"
						...
						<td>
							<table border="0" cellpadding="0" cellspacing="0" width="1280px">
								<tr align="left">
									...
									<td>
										起始时间:
										<s:textfield id="_startTime" name="start" size="20" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" My97Mark="false" value="%{startTime}" />
									</td>
									<td>
										代理注册起始时间:
									...
									<td>
										代理类型:<s:select name="agentType" list="#{1:'SEO',2:'电销',3:'推广',4:'广告'}" emptyOption="true"></s:select>
									</td>
									<td rowspan="2">
								...
								<tr align="left">
									...
									<td>
										结束时间:
										<s:textfield id="_endTime" name="end" size="20" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" My97Mark="false" value="%{endTime}" />
	  ...
	  <div id="right_04">
		  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#99c8d7">
            <tr>
              ...
              <td bgcolor="#0084ff" align="center"  style="font-size:13px;;color: #FFFFFF;font-weight: bold;cursor: pointer;" title="点击排序" >总盈利额</td>
            </tr>

           <s:iterator value="#request.page" var="customerAnalysis">
           <tr>
            ...
            <td <s:if test="#customerAnalysis.profitAllAmount>=100000">bgcolor="red"</s:if><s:else>bgcolor="#e4f2ff"</s:else> align="center"  style="font-size:13px;">
            		<s:property value="@dfh.utils.NumericUtil@formatDouble(#customerAnalysis.profitAllAmount)"/>
            </td>
           </tr>
           </s:iterator>
