...
<s:form action="queryBankCreditlogs" namespace="/office" name="mainform" id="mainform" theme="simple">
<div id="excel_menu_left">
记录 --> 银行额度记录 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>

<div id="excel_menu">
额度记录类型:<s:select name="bankCreditChangeType" list="%{#application.BankCreditChangeType}" listKey="code" listValue="text" emptyOption="true"/>
...
银行用户名:<s:textfield name="loginname" size="20"></s:textfield>
	...
	<div id="right_001">
	  ...
	  <div id="right_04">
		  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#99c8d7">
            <tr>
              <td bgcolor="#0084ff" align="center"  style="font-size:13px;;color: #FFFFFF;font-weight: bold;cursor: pointer;" title="点击排序" onclick="orderby('loginname');">银行用户名</td>
            ...
            <tr>
              <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;"><s:property value="#fc.bankname"/></td>
              <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;"><s:property value="@dfh.model.enums.BankCreditChangeType@getText(#fc.type)"/></td>
            ...
            <s:if test="#session.operator.authority=='boss' || #session.operator.authority=='finance_leader' || #session.operator.authority=='finance' || #session.operator.authority=='finance_manager' || #session.operator.authority=='sale_manager' || #session.operator.authority=='market_manager'">  
              ...
              <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;" colspan="2">总计:</td>
               <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;"><s:property value="@dfh.utils.NumericUtil@formatDouble(#request.page.statics1)"/></td>
              <td bgcolor="#e4f2ff" align="center"  style="font-size:13px;" colspan="6"></td>
            </tr>
            </s:if>
            <tr>
