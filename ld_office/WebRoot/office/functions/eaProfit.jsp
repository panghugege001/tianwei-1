...
function submitAction(btn){
   btn.disabled=true;
   var result = confirm("你确定要提交EA系统洗码?")
   if (result) {
     	 var action = "/batchxima/addEaXimaProposal.do";
...
function responseMethod(data){
	...
	<body>
		...
		<div id="excel_menu" style="position: absolute; top: 25px; left: 0px;">
			<s:form action="getEaList" namespace="/office" name="mainform"
						...
						<div id="right_04">
							<table width="1100px" border="0" cellpadding="0" cellspacing="1"
								...
								<tr bgcolor="#0084ff">
									...
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('pm');" width="90px">
										排名
									</td>
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('ztze');" width="90px">
										总投注额
									</td>
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('zsy');" width="90px">
										总输赢
									</td>
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('tzcs');" width="90px">
										投注次数
									</td>
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('pjtze');" width="90px">
										平均投注额
									</td>
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
									...
									<td align="center"
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('date');" width="130px">
										创建时间
									</td>
								</tr>
								...
								<s:iterator var="fc" value="%{#request.page.pageContents}">
									<s:if test="#fc.zsy>=500000">
										<c:set var="bgcolor" value="#FF9999" />
									</s:if>
									<s:elseif test="#fc.zsy>=50000">
										<c:set var="bgcolor" value="#D20000" />
									</s:elseif>
									<s:elseif test="#fc.zsy>=5000">
									...
									<tr bgcolor="${bgcolor}">
										...
										<td align="center" width="60px">
											<s:property value="#fc.pm" />
										</td>
										<td align="center" width="90px">
											<s:property
												value="@dfh.utils.NumericUtil@formatDouble(#fc.ztze)" />
										</td>
										<td align="center" width="90px">
											<s:property
												value="@dfh.utils.NumericUtil@formatDouble(#fc.zsy)" />
										</td>
										<td align="center" width="60px">
											<s:property value="#fc.tzcs" />
										</td>
										<td align="center" width="90px">
											<s:property
												value="@dfh.utils.NumericUtil@formatDouble(#fc.pjtze)" />
										</td>
										<td align="center" width="90px">
										    ${fc.starttime}
										</td>
									...
									<s:set var="amountValue" value="#fc.ztze" scope="request"></s:set>
									<c:set var="ztzeSum" value="${ztzeSum+amountValue}" scope="request"></c:set>

									<s:set var="amountPayOutValue" value="#fc.zsy" scope="request"></s:set>
									<c:set var="zsySum" value="${zsySum+amountPayOutValue}" scope="request"></c:set>
								</s:iterator>
