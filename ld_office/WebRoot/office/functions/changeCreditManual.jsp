...
frm.action="<c:url value='/office/getAccountInfoForChangeCreditManual.do' />";
frm.submit();
}
</script>
</head>
	<body>
		...
		<s:form action="changeCreditManual" onsubmit="submitonce(this);" namespace="/office" id="mainform" theme="simple">
