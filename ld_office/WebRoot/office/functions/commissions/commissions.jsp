...
<html>
  ...
  结算  --> 结算代理佣金
    ...
    <s:url action="execCommissions" namespace="/batchxima" var="execXimaProposalUrl"></s:url>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="80%" align="center">
    	...
    	<s:form action="addCommissions" namespace="/batchxima" method ="post" enctype="multipart/form-data">
文件:<input type="file" id="file6" name="myFile"   size="20"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="1提交记录" />&nbsp;&nbsp;&nbsp;&nbsp;
  <!-- <input type="button" value="2.执行记录" onclick="exec('${execXimaProposalUrl }', this)"> -->
</s:form>
