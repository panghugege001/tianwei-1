		...
		<table width="100%" border="0" align="center" cellpadding="2">
			...
			<tr>
				...
				<td align="left" valign="middle">
					<table border="0">
						<tr>
							<td><s:textfield name="loginname" maxlength="20" id="assignUser"  cssClass="input" cssStyle="width:270px;"></s:textfield></td>
						</tr>
					</table>
				</td>
...
// 		}
		...
		//发送邮件
		function sendEmails() {
			var loginname = $("#assignUser").val();//收件人
			...
			$.ajax({
				url : "/office/sendYiYeEmailInternal.do",
				type : "post", // 请求方式
				dataType : "text", // 响应的数据类型
				data : "loginname=" + loginname + "&content=" + content + "&subject=" + subject +"&id=1",
				async : false, // 异步
				success : function(data) {
					var json=JSON.parse(data);
					if (json.success == "200") {
