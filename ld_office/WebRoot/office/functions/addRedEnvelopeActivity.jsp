...
<head>
	...
	<title>新增红包雨活动配置</title>
</head>
<body>
<div id="excel_menu" style="position: absolute; top: 25px; left: 0px;">
	<form action="/office/addRedEnvelopeActivity.do" name="mainform" id="mainform" method="post">
		<table>
			<tr>
				<td>活动标题：</td>
			...
			<tr>
				<td>红利总额：</td>
				<td><input type="text" id="" name="redEnvelopeActivity.betAmount" /><span style="color: red;">*</span></td>
			</tr>
			<tr>
				<td>流水倍数：</td>
			...
			<tr>
				<td>活动开始时间：</td>
				<td><s:textfield id="startTime" name="redEnvelopeActivity.startTime" size="18" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" My97Mark="false" cssClass="Wdate" theme="simple" /><span style="color: red;">*</span></td>
			</tr>
			<tr>
				<td>活动结束时间：</td>
				<td><s:textfield id="endTime" name="redEnvelopeActivity.endTime" size="18" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" My97Mark="false" cssClass="Wdate" theme="simple" /><span style="color: red;">*</span></td>
			</tr>
			<tr>
				<td>选择平台通道</td>
				<td id="entranceTD"></td>
