...
<html>
  ...
  <body style="background:#b6d9e4;">
   操作  --> 批量抽奖
    ...
    <s:url action="execPrize" namespace="/batchxima" var="execProfitProposalUrl"></s:url>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="80%" align="center">
    	...
    	<tr align="center">
    		<th>
    			...
    			<input type="button" value="2.执行提案" onclick="exec('${execProfitProposalUrl }', this)">
    	...
    	<s:form action="addBatchPrizeProposal" namespace="/batchxima" method ="post" enctype="multipart/form-data">
文件:<input type="file" id="file6" name="myFile"   size="20"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="1提交抽奖文件" />
</s:form>
