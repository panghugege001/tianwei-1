						...
						<div id="right_04">
							<table width="900px" border="0" cellpadding="0" cellspacing="1"
								...
								<tr bgcolor="#0084ff">
									...
									<td align="center" 
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('betCredit');" width="90px">
										投注额
									</td>
									<td align="center" 
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('payOut');" width="90px">
										赔付
									</td>
									<td align="center" 
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" onclick="orderby('starttime');" width="90px">
										时间
									</td>
									<td align="center" 
										style="color: #FFFFFF; font-weight: bold; cursor: pointer;"
										title="点击排序" width="90px">
										投注详情
									</td>
								</tr>
								...
								<c:set var="amountPayOut" value="0" scope="request"></c:set>
								 <s:iterator var="fc" value="%{#request.page.pageContents}">
									...
									<tr bgcolor="${bgcolor}">
										...
										<td align="right" width="90px">
											<s:property
												value="@dfh.utils.NumericUtil@formatDouble(#fc.betCredit)" />
										</td>
										<td align="right" width="90px">
											<s:property
												value="@dfh.utils.NumericUtil@formatDouble(#fc.payOut)" />
										</td>
										<td align="right" width="90px">
										   <fmt:formatDate value='${fc.starttime}' pattern='yyyy-MM-dd'/>
										</td>
										<td align="center" bgcolor="#F0FFF0" align="center">
												<a
													href="${ctx}/office/getPtListInfo.do?username=${fc.loginname}&start=${fc.starttime}&end=${fc.endtime}"
								...
								<tr bgcolor="#e4f2ff">
									...
									<td align="right">
										<s:property
											value="@dfh.utils.NumericUtil@double2String(#request.amountPayOut)" />
									</td>
									<td align="right">
									</td>
									<td align="right">
