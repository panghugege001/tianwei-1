...
<body>
<p>
记录 --&gt; 人民币事务提案记录 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</p>
<div  id="excel_menu" style="position:absolute; top:25px;left:0px;">
<s:form action="queryBsinessProposal" namespace="/office" name="mainform" id="mainform" theme="simple">
	  ...
	  <div id="right_04">
		  <table width="1110px"  border="0" cellpadding="0" cellspacing="1" bgcolor="#99c8d7" >
            ...
            <c:set var="amountSum" value="${amountSum+amountValue}"  scope="request"></c:set>
  	 	   ...
  	 	   <s:if test="#session.operator.authority=='fnfh' || #session.operator.authority=='boss' || #session.operator.authority=='finance' || #session.operator.authority=='finance_leader' || #session.operator.authority=='finance_manager' || #session.operator.authority=='sale_manager' || #session.operator.authority=='market_manager'">  
  	 	   <tr bgcolor="#e4f2ff">
