...
function computeTryCredit(){
	...
	if(!isNaN(frm.firstCash.value)){
		//frm.tryCredit.value=formatNumber(parseFloat(frm.firstCash.value)*0.68,1);
		var fc=(frm.firstCash.value*0.68).toFixed(2); 
		frm.tryCredit.value=fc;
...
操作 --> 开户优惠提案 <a href="javascript:history.back();"><font color="red">上一步</font></a>
</div>

<div id="excel_menu">
<p align="left"><s:fielderror/></p>
<s:form action="addConcessionsProposal" onsubmit="submitonce(this);" namespace="/office" name="mainform" id="mainform" theme="simple">
<table align="left" >
<tr><td>用户类别:</td><td>
...
<tr><td>第一笔存款金额:</td><td><s:textfield name="firstCash" size="30" onblur="computeTryCredit()" /></td></tr>
<tr><td>申请优惠金额:</td><td><s:textfield name="tryCredit"  size="30"/></td></tr>
