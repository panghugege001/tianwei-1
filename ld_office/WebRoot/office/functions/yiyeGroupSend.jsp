...
function duanXinQunFaCommit(ids){
	...
	$.post("/office/duanXinQunFa4Internation.do",{"ids":ids,"remark":remark},function(respData){
		alert(respData);
	});
}
...
$(document).ready(function check(){
	...
	if(authorityText=='boss'||authorityText=='admin' || authorityText=='market_manager' || authorityText=='market' ||(csText!=null&&csText!='')||(typeText!=null&&typeText!='')){
							...
							<table width="1250px" border="0" align="center" cellpadding="0"
								...
								<tr align="left">
									<td colspan="12" align="left">
										<s:form action="queryPhoneforSendGroup" namespace="/office" name="mainform" id="mainform" theme="simple">
											<table border="0" cellpadding="0" cellspacing="0">
												...
												<tr>
													...
													<s:textfield name="type" id="type" size="15" />
													</s:if>
													<s:else>
													<s:textfield name="type" id="type" size="15" value="%{#session.operator.type}"  readonly="true"/>
													</s:else>--%>
													</td>
												</tr>
												<tr>
								...
								<s:iterator var="fc" value="%{#request.page.pageContents}">
									<tr>
										...
										<s:if test='#session.operator.type!="all"'>
											<td align="center" bgcolor="#F0FFF0" align="center"
												width="60px" style="font-weight: bold; cursor: pointer;">
												<s:if test="#fc.qq !='' && #session.operator.authority.contains('market')">
