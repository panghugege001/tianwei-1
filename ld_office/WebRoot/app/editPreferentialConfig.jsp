...
<html>
	...
	<body>
		<div id="excel_menu" style="position: absolute; top: 25px; left: 0px;">
			<form action="/app/updatePreferentialConfig.do" name="mainform" id="mainform" method="post">
				<table>
					<tr>
						<td>游戏平台：</td>
						<td>
					...
					<tr>
						<td>启用开始时间：</td>
						<td>
							<s:textfield id="startTime" name="preferentialConfig.startTime" size="18" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" My97Mark="false" cssClass="Wdate" theme="simple" /> 
							<span style="color: red;">*</span>
						</td>
					</tr>
					<tr>
						<td>启用结束时间：</td>
						<td>
							<s:textfield id="endTime" name="preferentialConfig.endTime" size="18" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" My97Mark="false" cssClass="Wdate" theme="simple" /> 
							<span style="color: red;">*</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>机器码验证是否开启：</td>
						<td>
							<label><input type='radio' name='machineEnabled' value="0" />否</label> 
							<label><input type='radio' name='machineEnabled' value="1" checked />是</label>
						</td>
					</tr>
					<tr>
						<td>机器码使用次数：</td>
				...
				<input type="hidden" id="id" name="preferentialConfig.id" />
