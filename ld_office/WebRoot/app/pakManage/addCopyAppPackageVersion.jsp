...
<html>
	<head>
		...
		<title>复制新增版本信息</title>
	</head>
	<body>
		<div style="position: absolute; top: 25px; left: 0px;">
			<form action="/appPak/addCopyAppPackageVersion.do" name="mainform" id="mainform" method="post" enctype="multipart/form-data">
				<table border="0">
					<tbody>
						<tr>
							<td>版本标题：</td>
						...
						<tr>
							<td>版本号：</td>
							<td>
								<input type="text" name="appPackageVersion.versionCode" id="versionCode" value="${appPackageVersion.versionCode}x"/>
								<span style="color: red;">*</span>
							</td>
						</tr>
						<tr>
							<td>App平台：</td>
							<td>
								<s:select list="#{ 'android': '安卓', 'iOS': 'iOS' }" name="appPackageVersion.plat" id="plat" listKey="key" listValue="value" cssStyle="width: 100px;" theme="simple" value="0"></s:select>
							</td>
						</tr>
						<tr>
							<td>状态：</td>
