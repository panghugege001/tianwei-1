...
<body>
	...
	<div style="width:100%;height:60px;">
		<s:form action="queryAppPackageVersionListSomeRights" namespace="/appPak"
	...
	<script type="text/javascript">
		...
		function querySubmit(){
			window.parent.frames[1].location.href="<c:url value='/app/pakManage/appPackageVersionCustomSomeRights.jsp' />"; //window.parent.frames[1].document.getElementById('bottomFrame').contentWindow.location.href="...";
		...
		function addCopyVersion(control,id) {
			...
			var url = "/appPak/singleCopyAppPackageVersionSomeRights.do?appPackageVersion.id="+id;
