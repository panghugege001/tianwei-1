...
//        uc.uc_user_edit_user("david168", "david168", "123456");
...
//		System.out.println(s);
	...
	public static void testLogin(){
		...
		Client e = new Client();
		String result = e.uc_user_login("david", "ddtao199003036819");
...
//		生成同步退出的代码
	...
	public static void testRegister(){
		...
		//setcookie('Example_auth', '', -86400);
//		生成同步退出的代码
		String $returns = uc.uc_user_register("woodytest123", "e739279cb28cdafd7373618313803524" ,"ccc3c123@abc.com" );
