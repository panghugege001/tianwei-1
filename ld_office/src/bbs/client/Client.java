...
public class Client extends PHPFunctions {
    ...
    public static String UC_IP = "123.1.182.134";
    public static String UC_API = "http://bbs.e68ph.net/uc_server";
    public static String UC_CONNECT = "";
    public static String UC_KEY = "k7L48aFbZbv3Zfhbc6F2ubC3Fc6f8cWbIby9e6abu9H3y1u8g0I0DaBaq2DbZcI2";
    ...
    static {
        UC_API = "http://apibbs.e68ph.net/uc_server";
        UC_IP = "127.0.0.1";
        UC_KEY = "dbi9pa5dB2HbHfucn0S1tc66H9dfD2u060G0w9Q464Pdv648Bbf6cccf63w1HbN3";
        UC_APPID = "1";
        UC_CONNECT = "";
    }
...
//		}
    ...
    public String uc_user_edit_user(String $username, String $oldpw, String $newpw) {
        return uc_user_edit($username,$oldpw,$newpw,"",1,  "",  "");
    }
