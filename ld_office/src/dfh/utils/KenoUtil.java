...
public class KenoUtil {
	...
	static String FundLink="http://www.longdu97.com/transfer_memberkeno.asp"; 
	...
	public static String transferconfirm(String PlayerId,Double amount,
			String PlayerIP,Integer FundIntegrationId,String VendorRef) {
		HttpClient httpClient=new HttpClient();
	...
	public static String transferfirst(String PlayerId,Double amount,
			String PlayerIP,String VendorRef) {
		HttpClient httpClient=new HttpClient();
