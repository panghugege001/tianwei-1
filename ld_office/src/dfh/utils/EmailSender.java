	...
	public void send() {
		try {
			...
			for (int i = 0; i < toemaillength; i++) {
				...
				boolean flag=false;
//				if(!toEmails[i].trim().equals("")){
//					flag = true;
//				}
				
				if(toEmails[i].trim().endsWith("@qq.com")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@QQ.COM")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@163.com")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@163.COM")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@sina.com")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@SINA.COM")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@yahoo.com.cn")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@126.com")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@yahoo.cn")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@sohu.com")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@e68.ph")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@gmail.com")){
					flag = true;
				}else if(toEmails[i].trim().endsWith("@gsmc.im")){
					flag = true;
				}
				...
				//message.setRecipients(Message.RecipientType.TO, toAddress[i]);
				
				message.setRecipient(Message.RecipientType.TO, new InternetAddress(toEmails[i].trim()));
