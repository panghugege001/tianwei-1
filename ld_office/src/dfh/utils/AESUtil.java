...
//		return new BASE64Encoder().encode(bytes);
	...
	public static void main(String[] args) throws Exception {
		...
		String email = "oyoyovip@vip.qq.com";
		String a = AESUtil.aesEncrypt(email, AESUtil.KEY);
		System.out.println(a);
		
		String content = "13627650150";
//		String content = "13898989898";
		
		String encrypt = aesEncrypt(content, KEY);
		System.out.println("加密后：" + encrypt);
		
		String decrypt = aesDecrypt("ATIHMAd9tf8m9SXyWirRFA==", KEY);
