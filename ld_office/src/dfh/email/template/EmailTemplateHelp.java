...
public class EmailTemplateHelp {
	...
	public static void readerEmailTemplate()throws Exception{		
		...
		doc = reader.read(EmailTemplateHelp.class.getResourceAsStream("/dfh/email/template/registeragentbody.xml"));
		e = doc.getRootElement();
		Constants.EMAIL_REGISTER_BODY_HTML=e.asXML();
		
		doc = reader.read(EmailTemplateHelp.class.getResourceAsStream("/dfh/email/template/cashinbody.xml"));
		e = doc.getRootElement();
		Constants.EMAIL_CASHIN_BODY_HTML=e.asXML();
		
		doc = reader.read(EmailTemplateHelp.class.getResourceAsStream("/dfh/email/template/cashoutbody.xml"));
		e = doc.getRootElement();
		Constants.EMAIL_CASHOUT_BODY_HTML=e.asXML();
