 ...
 */
@Entity
@Table(name = "users_backup", catalog = "tianwei")
@org.hibernate.annotations.Entity(dynamicUpdate = true, dynamicInsert = true)
public class UsersBackup implements java.io.Serializable {
	...
	/** minimal constructor */
	public UsersBackup(String loginname, String password, Double credit, String md5str, Integer flag, String role, Integer loginTimes) {
	...
	/** full constructor */
	public UsersBackup(String loginname, String password, Double credit, Timestamp lastLoginTime, Integer level, String md5str, String agent, String partner, String accountName, String phone, Integer flag,
