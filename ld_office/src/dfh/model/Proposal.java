...
public class Proposal implements java.io.Serializable {
	...
	/** minimal constructor */
	public Proposal(String pno, String proposer, Timestamp createTime, Integer type, Integer quickly, Integer flag, String whereisfrom,String agent) {
		this.pno = pno;
	...
	@javax.persistence.Column(name = "shippinginfo")
	...
	@javax.persistence.Column(name = "mssgflag")
