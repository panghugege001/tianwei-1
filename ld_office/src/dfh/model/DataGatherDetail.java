...
@Entity
@Table(name = "data_gather_detail", catalog = "tianwei")
@org.hibernate.annotations.Entity(dynamicUpdate = true, dynamicInsert = true)
public class DataGatherDetail implements Serializable {

	private static final long serialVersionUID = 1L;

	//
	private DataGatherDetailId id;
	// 所属代理账号
	...
	public DataGatherDetail() {

	}

	@EmbeddedId
	@javax.persistence.Column(name = "id")
	public DataGatherDetailId getId() {
		return id;
	}

	public void setId(DataGatherDetailId id) {
		this.id = id;
	}
