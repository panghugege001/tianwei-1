...
public class AgProfit implements java.io.Serializable {
	...
	/** minimal constructor */
	public AgProfit(String pno, String proposer, Timestamp createTime, Integer type, Integer quickly, Integer flag, String whereisfrom,String agent) {
		this.pno = pno;
	...
	/** minimal constructor */
	public AgProfit(String pno, String proposer, Timestamp createTime, Integer type, Integer quickly, String loginname, Double amount, String agent, Integer flag, String whereisfrom, String remark) {
		this.pno = pno;
		this.proposer = proposer;
		this.createTime = createTime;
		this.type = type;
