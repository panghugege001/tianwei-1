...
public class AuditDetail {
	...
	private Proposal lastCashout;
	private Proposal currentCashout;

	public Proposal getLastCashout() {
		return lastCashout;
	}

	public void setLastCashout(Proposal lastCashout) {
		this.lastCashout = lastCashout;
	}

	public Proposal getCurrentCashout() {
		return currentCashout;
	}

	public void setCurrentCashout(Proposal currentCashout) {
		this.currentCashout = currentCashout;
	}
