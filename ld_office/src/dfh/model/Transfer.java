...
public class Transfer  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Transfer(Long id, String source, String target, Double remit, String loginname, Timestamp createtime, Double credit, Double newCredit, Integer flag) {
        this.id = id;
        this.source = source;
        this.target = target;
        this.remit = remit;
    ...
    /** full constructor */
    public Transfer(Long id, String source, String target, Double remit, String loginname, Timestamp createtime, Double credit, Double newCredit, Integer flag, String paymentid, String remark) {
        this.id = id;
        this.source = source;
        this.target = target;
        this.remit = remit;
