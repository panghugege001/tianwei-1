...
public class UsersAgent implements java.io.Serializable {
	...
	/** minimal constructor */
	public UsersAgent(String loginname, String password, Double credit, String md5str, Integer flag, String role, Integer loginTimes) {
	...
	/** full constructor */
	public UsersAgent(String loginname, String password, Double credit, Timestamp lastLoginTime, Integer level, String md5str, String agent, String partner, String accountName, String phone, Integer flag,
	...
	@javax.persistence.Column(name = "tyrebate")
