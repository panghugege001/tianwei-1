...
public class ReplyInfoDao extends MyTwoHibernateDaoSupport {
	...
	public void deleteByTopicId(Integer topicId)  {
		String sql = "delete from replyinfo where topic_id = "+topicId;
		this.getSession().createSQLQuery(sql).executeUpdate();
	}
	
	public void batchDelete(String ids) throws Exception {
		String sql = "delete from replyinfo where topic_id in ("+ids+")";
		this.getSession().createSQLQuery(sql).executeUpdate();
	}
}
