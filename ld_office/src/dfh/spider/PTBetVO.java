...
//		if(StringUtils.isNotBlank(progressviceWin) && !"CNY0.0000".equals(progressviceWin)){
//			this.profit = Arith.sub(this.profit, (Double) NumberFormat.getNumberInstance(java.util.Locale.US).parse(progressviceWin.replace("CNY", "")).doubleValue());
//		}
	}
