...
public class NTwoDepositPendingResponseBean {
	private String id;
	...
	public NTwoDepositPendingResponseBean(String id, String agcode, String status, String refno, String paymentid, String errdesc) {
		super();
		this.id = id;
		this.agcode = agcode;
		this.status = status;
