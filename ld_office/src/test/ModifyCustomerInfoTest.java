...
public class ModifyCustomerInfoTest extends TestCase{
	...
	public void testExecute()
	{
		...
		{
		assertEquals(3, 2+1);
//		assertEquals(null , customerService.modifyCustomerInfo(loginname, StringUtils.trim(aliasname), StringUtils.trim(phone), StringUtils.trim(email), getIp()));
		}
		catch(Exception ex)
		{
