...
@Entity
@Table(name = "AG_DATA_QLE")
@org.hibernate.annotations.Entity(dynamicUpdate = true, dynamicInsert = true)
public class AgDataQLE extends AGData4OracleVO   implements java.io.Serializable {
...
//	public AgDataQY(String billNo,String playerName,Double beforeCredit,Double betamount,Double validbetamount,Double netamount,Double jackpot,Date betTime,Date lastupdate,Date createtime,String gameType,String platform) {
//		this.billNo=billNo;
